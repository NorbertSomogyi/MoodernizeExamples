...
public class node {
	...
	public node[] node_create(node[] parent_node) {
		node node = new node();
		node = .malloc();
	...
	public Object find_container(Object compare, node[] node, Object[] key, Object start_container) {
		int left;
		int right;
		int middle;
		int result;
	...
	// ========================== Debug Area ==========================
	// ================================================================
	public void validate_containers(node[] node, Object compare) {
		int i;
	...
	public void bftree_node_print(node[] node) {
		int i;

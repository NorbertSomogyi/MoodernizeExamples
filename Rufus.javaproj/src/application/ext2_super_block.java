...
public class ext2_super_block {
	...
	public Object ext2fs_initialize(Object name, int flags, Object manager, Object ret_fs) {
		...
		if (time_env) {
			fs.setNow(/*Error: Function owner not recognized*/strtoul(time_env, (null), 0));
		} 
		io_flags = IO_FLAG_RW;
		if (flags & -1024) {
		...
		super.setS_mkfs_time(super.setS_lastcheck(fs.getNow() ? fs.getNow() : /*Error: Function owner not recognized*/time((null))));

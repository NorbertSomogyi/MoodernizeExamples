...
public class ext2_inode {
	...
	public Object punch_extent_blocks(Object fs, Object ino, Object lfree_start, Object free_start, Object free_count, Integer freed) {
		 pblk = new ();
		int freed_now = 0;
		 cluster_freed = new ();
		 retval = 0;
	...
	public Object ext2fs_punch_inline_data(Object fs, Object ino, Object start, Object end) {
		...
		Object[] generatedI_block = this.getI_block();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memset((byte)generatedI_block, 0, ((/*Error: Unsupported expression*/ * (((12 + 1) + 1) + 1))));
		this.setI_size(0);
	...
	public Object ext2fs_inode_data_blocks2(Object fs) {
		...
		return (generatedExt2_inode | (fs.getSuper().ext2fs_has_feature_huge_file() ? ()generatedExt2_inode.getLinux2().getL_i_blocks_hi() << 32 : 0)) - (generatedExt2_inode ? /*Error: Function owner not recognized*/EXT2_CLUSTER_SIZE(fs.getSuper()) >> 9 : 0/*
	...
	public int ext2fs_is_fast_symlink() {
		...
		Object[] generatedI_block = this.getI_block();
		return (((generatedI_mode) & 170000) == 120000) && (generatedI_size | (/*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(inode).getI_size_high() << 32)) && (generatedI_size | (/*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(inode).getI_size_high() << 32)) < /*Error: sizeof expression not supported yet*/;
	}
	...
	public Object ext2fs_inline_data_file_expand(Object fs, Object ino, Byte buf, Object size) {
		ext2_file_t e2_file = new ext2_file_t();
		 retval = new ();
		Object[] generatedI_block = this.getI_block();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memset(generatedI_block, 0, /*Error: sizeof expression not supported yet*/);
		Object generatedI_flags = this.getI_flags();
		if (fs.getSuper().ext2fs_has_feature_extents()) {
	...
	public Object ext2fs_inline_data_get(Object fs, Object ino, Object buf, Object size) {
		...
		Object[] generatedI_block = this.getI_block();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(buf, (Object)generatedI_block, ((/*Error: Unsupported expression*/ * (((12 + 1) + 1) + 1))));
		Object generatedEa_size = data.getEa_size();
		Object generatedEa_data = data.getEa_data();
		if (generatedEa_size > 0) {
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy((byte)buf + ((/*Error: Unsupported expression*/ * (((12 + 1) + 1) + 1))), generatedEa_data, generatedEa_size);
		} 
		if (size) {
	...
	public Object ext2fs_inline_data_set(Object fs, Object ino, Object buf, Object size) {
		ext2_inode inode_buf = new ext2_inode();
		ext2_inline_data data = new ext2_inline_data(/*Error: Invalid initializer*/, /*Error: Invalid initializer*/);
		 retval = new ();
		...
		Object[] generatedI_block = this.getI_block();
		if (size <= ((/*Error: Unsupported expression*/ * (((12 + 1) + 1) + 1)))) {
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy((Object)generatedI_block, buf, size);
		} else {
				...
				if (existing_size < ((/*Error: Unsupported expression*/ * (((12 + 1) + 1) + 1)))) {
					free_inode_size = ((/*Error: Unsupported expression*/ * (((12 + 1) + 1) + 1))) - existing_size;
				} else {
						free_inode_size = 0;
				} 
				...
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy((Object)generatedI_block, buf, ((/*Error: Unsupported expression*/ * (((12 + 1) + 1) + 1))));
				if (size > ((/*Error: Unsupported expression*/ * (((12 + 1) + 1) + 1)))) {
					data.setEa_size(size - ((/*Error: Unsupported expression*/ * (((12 + 1) + 1) + 1))));
				} 
				data.setEa_data((byte)buf + ((/*Error: Unsupported expression*/ * (((12 + 1) + 1) + 1))));
		} 
		retval = inode.ext2fs_write_inode(fs, ino);
		if (retval) {
			return retval;
	...
	public Object ext2fs_extent_open2(Object fs, Object ino, Object ret_handle) {
		...
		retval = ModernizedCProgram.ext2fs_get_mem(/*Error: Unsupported expression*/, handle);
		if (retval) {
			return retval;
		} 
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memset(handle, 0, /*Error: Unsupported expression*/);
		handle.setIno(ino);
		handle.setFs(fs);
		...
		if (i >= (((12 + 1) + 1) + 1)) {
			eh.setExt3_extent_header(/*Error: Function owner not recognized*/ext2fs_cpu_to_le16(EXT3_EXT_MAGIC));
			eh.setExt3_extent_header(0);
			eh.setExt3_extent_header(0);
			i = (/*Error: sizeof expression not supported yet*/ - /*Error: sizeof expression not supported yet*/) / /*Error: Unsupported expression*/;
			eh.setExt3_extent_header(/*Error: Function owner not recognized*/ext2fs_cpu_to_le16(i));
			generatedI_flags |=  -1024;
		} 
		if (!(generatedI_flags & -1024)) {
		...
		retval = ModernizedCProgram.ext2fs_extent_header_verify(eh, /*Error: sizeof expression not supported yet*/);
		if (retval) {
			;
		} 
		Object generatedExt3_extent_header = eh.getExt3_extent_header();
		handle.setMax_depth(/*Error: Function owner not recognized*/ext2fs_le16_to_cpu(generatedExt3_extent_header));
		handle.setType(/*Error: Function owner not recognized*/ext2fs_le16_to_cpu(generatedExt3_extent_header));
		...
		retval = ModernizedCProgram.ext2fs_get_memzero(generatedMax_paths * /*Error: Unsupported expression*/, generatedPath);
		generatedPath[0].setBuf((byte)generatedI_block);
		generatedPath[0].setLeft(generatedPath[0].setEntries(/*Error: Function owner not recognized*/ext2fs_le16_to_cpu(generatedExt3_extent_header)));
		generatedPath[0].setMax_entries(/*Error: Function owner not recognized*/ext2fs_le16_to_cpu(generatedExt3_extent_header));
		generatedPath[0].setCurr(0);
		Object generatedI_size = (generatedInode).getI_size();
		generatedPath[0].setEnd_blk(((generatedI_size | (/*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(generatedInode).getI_size_high() << 32)) + fs.getBlocksize() - 1) >> ((fs.getSuper()).getS_log_block_size() + 10));
	...
	public Object ext2fs_file_open2(Object fs, Object ino, int flags, Object ret) {
		...
		retval = ModernizedCProgram.ext2fs_get_mem(/*Error: Unsupported expression*/, file);
		if (retval) {
			return retval;
		} 
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memset(file, 0, /*Error: Unsupported expression*/);
		file.setMagic(EXT2_ET_MAGIC_EXT2_FILE);
		file.setFs(fs);
		file.setIno(ino);
		file.setFlags(flags & -1024);
		if (inode) {
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(file.getInode(), inode, /*Error: Unsupported expression*/);
		} else {
	...
	public Object extent_fallocate(Object fs, int flags, Object ino, Object goal, Object start, Object len) {
		...
		if (err == EXT2_ET_NO_CURRENT_NODE) {
			...
			goal += start;
			err = ModernizedCProgram.ext_falloc_helper(fs, flags, ino, inode, handle, (null), (null), start, len, goal);
			;
		}  else if (err) {
			;
		} 
		...
		if (generatedE_lblk > start) {
			...
			err = ModernizedCProgram.ext_falloc_helper(fs, flags, ino, inode, handle, (null), left_extent, start, generatedE_lblk - start, goal);
			if (err) {
				;
			} 
			;
	...
	public Object ext2fs_fallocate(Object fs, int flags, Object ino, Object goal, Object start, Object len) {
		...
		for (blk = start; blk < start + len; /* XXX: Allocate a bunch of blocks the slow way */blk++) {
			...
			err = inode.ext2fs_bmap2(fs, ino, (null), 0, blk, 0, x);
			if (err) {
				return err;
			} 
			if (x) {
			...
			err = inode.ext2fs_bmap2(fs, ino, (null), -1024 | -1024 | -1024, blk, 0, x);
			if (err) {
				return err;
			} 
		}
	...
	public int ext2fs_inode_has_valid_blocks() {
		return inode.ext2fs_inode_has_valid_blocks2((null));
	}
	public Object ext2fs_get_next_inode_full(Object scan, Object ino, int bufsize) {
		...
		if (scan.getBytes_left() < scan.getInode_size()) {
			if (scan.getBytes_left()) {
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(scan.getTemp_buffer(), scan.getPtr(), scan.getBytes_left());
			} 
		...
		if (extra_bytes) {
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(scan.getTemp_buffer() + extra_bytes, scan.getPtr(), scan.getInode_size() - extra_bytes);
			...
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(iptr, scan.getTemp_buffer(), length);
			if (scan.getScan_flags() & -1024) {
			...
			scan.getScan_flags() &=  ~-1024;
				...
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(iptr, scan.getPtr(), length);
		...
		if (iptr != (ext2_inode_large)inode) {
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(inode, iptr, bufsize);
			ModernizedCProgram.ext2fs_free_mem(iptr);
		} 
		return retval;
	}
	public Object ext2fs_get_next_inode(Object scan, Object ino) {
		return inode.ext2fs_get_next_inode_full(scan, ino, /*Error: Unsupported expression*//*
	...
	public Object ext2fs_read_inode2(Object fs, Object ino, int bufsize, int flags) {
		...
		if (fs.getRead_inode() && ((bufsize == /*Error: Unsupported expression*/) || ((((fs.getSuper()).getS_rev_level() == 0) ? 128 : (fs.getSuper()).getS_inode_size()) == /*Error: Unsupported expression*/))) {
			retval = /*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(fs, ino, inode);
		...
		for (i = 0; i < fs.getIcache().getCache_size(); /* Check to see if it's in the inode cache */i++) {
			if (fs.getIcache().getCache()[i].getExt2_inode_cache_ent() == ino) {
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(inode, fs.getIcache().getCache()[i].getExt2_inode_cache_ent(), (bufsize > length) ? length : bufsize);
				return 0;
			} 
		}
		if (fs.getFlags() & -1024) {
			inodes_per_block = fs.getBlocksize() / (((fs.getSuper()).getS_rev_level() == 0) ? 128 : (fs.getSuper()).getS_inode_size());
			block_nr = /*Error: Function owner not recognized*/ext2fs_le32_to_cpu(fs.getImage_header().getExt2_image_hdr()) / fs.getBlocksize();
		...
		while (length) {
			...
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(ptr, ((byte)fs.getIcache().getBuffer()) + (int)offset, clen);
			offset = 0;
			length -= clen;
			ptr += clen;
			block_nr++;
		...
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(inode, iptr, (bufsize > length) ? length : bufsize);
	...
	public Object ext2fs_read_inode(Object fs, Object ino) {
		return inode.ext2fs_read_inode2(fs, ino, /*Error: Unsupported expression*/, 0);
	}
	public Object ext2fs_write_inode2(Object fs, Object ino, int bufsize, int flags) {
		...
		if (fs.getIcache()) {
			for (i = 0; i < fs.getIcache().getCache_size(); i++) {
				if (fs.getIcache().getCache()[i].getExt2_inode_cache_ent() == ino) {
					/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(fs.getIcache().getCache()[i].getExt2_inode_cache_ent(), inode, (bufsize > length) ? length : bufsize);
					break;
				} 
			}
		} else {
		...
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(w_inode, inode, (bufsize > length) ? length : bufsize);
		if (!(fs.getFlags() & -1024)) {
		...
		while (length) {
			...
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy((byte)fs.getIcache().getBuffer() + (int)offset, ptr, clen);
	...
	public Object ext2fs_write_inode(Object fs, Object ino) {
		return inode.ext2fs_write_inode2(fs, ino, /*Error: Unsupported expression*/, 0/*
	...
	public Object ext2fs_write_new_inode(Object fs, Object ino) {
		...
		ext2_inode_large large_inode = new ext2_inode_large();
		 retval = new ();
		 t = fs.getNow() ? fs.getNow() : /*Error: Function owner not recognized*/time((null));
		...
		if (size == /*Error: Unsupported expression*/) {
			return inode.ext2fs_write_inode_full(fs, ino, /*Error: Unsupported expression*/);
		} 
		buf = /*Error: Function owner not recognized*/malloc(size);
		if (!buf) {
			return 12;
		} 
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memset(buf, 0, size);
		buf = inode;
		large_inode = (ext2_inode_large)buf;
		large_inode.setI_extra_isize(/*Error: Unsupported expression*/ - 128);
	...
	public void ext2fs_set_ea_inode_ref(Object ref_count) {
		this.setI_ctime(/*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(ref_count >> 32));
		 generatedOsd1 = this.getOsd1();
		Object generatedLinux1 = generatedOsd1.getLinux1();
	...
	public Object ext2fs_find_inode_goal(Object fs, Object ino, Object lblk) {
		...
		/* Make sure data stored in inode->i_block is neither fast symlink nor
			 ...
			 */
		Object generatedI_flags = this.getI_flags();
		if (inode == (null) || inode.ext2fs_is_fast_symlink() || generatedI_flags & -1024) {
			;
		} 
		Object generatedE_pblk = extent.getE_pblk();
		Object generatedE_lblk = extent.getE_lblk();
	...
	public Object extent_bmap(Object fs, Object ino, Object handle, Byte block_buf, int bmap_flags, Object block, Integer ret_flags, Integer blocks_alloc, Object phys_blk) {
	...
	public Object ext2fs_bmap2(Object fs, Object ino, Byte block_buf, int bmap_flags, Object block, Integer ret_flags, Object phys_blk) {
		ext2_inode inode_buf = new ext2_inode();
		ext2_extent_handle_t handle = 0;
		 addr_per_block = new ();
		 b = new ();
		...
		int blocks_alloc = 0;
		int inode_dirty = 0;
		blk_alloc_ctx alloc_ctx = new blk_alloc_ctx(/*Error: Invalid initializer*/, /*Error: Invalid initializer*/, /*Error: Invalid initializer*/, /*Error: Invalid initializer*/);
		if (!(bmap_flags & -1024)) {
			phys_blk = 0;
		} 
		if (ret_flags) {

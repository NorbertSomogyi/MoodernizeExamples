...
public class ext2_dir_entry {
	 ...
	 * %End-Header%
	 */
	public Object ext2fs_get_rec_len(Object fs, int rec_len) {
	...
	public int xlate_func(Object dir, int entry, int offset, int blocksize, Byte buf, Object priv_data) {
		...
		return .UNRECOGNIZEDFUNCTIONNAME(dirent, offset, blocksize, buf, generatedReal_private);
		xlate xl = (xlate)priv_data;
		Object generatedReal_private = xl.getReal_private();
		return .UNRECOGNIZEDFUNCTIONNAME(fs, blocknr, (int)blockcnt, generatedReal_private);
	}
	public int link_proc(int offset, int blocksize, Byte buf, Object priv_data) {
		...
		if (/* De-convert a dx_node block */csum_size && curr_rec_len == generatedFs.getBlocksize() && !generatedInode) {
			...
			t = ((ext2_dir_entry_tail)(((byte)(buf)) + (generatedFs.getBlocksize()) - ));
		...
		.strncpy(generatedName, generatedName, generatedNamelen);
	...
	public int lookup_proc(int offset, int blocksize, Byte buf, Object priv_data) {
		...
		if (.strncmp(generatedName, generatedName, ModernizedCProgram.ext2fs_dirent_name_len(dirent))) {
			return 0;
		} 
	...
	public Object ext2fs_dirent_csum(Object fs, Object inum, Object crc, int size) {
		...
		gen = .ext2fs_cpu_to_le32(generatedI_generation);
	...
	public int ext2fs_dirent_csum_verify(Object fs, Object inum) {
		...
		return .ext2fs_le32_to_cpu(generatedDet_checksum) == calculated;
	}
	public Object ext2fs_dirent_csum_set(Object fs, Object inum) {
		...
		t.setDet_checksum(.ext2fs_cpu_to_le32(crc));
		return 0;
	}
	public int ext2fs_dx_csum_verify(Object fs, Object inum) {
		...
		limit = .ext2fs_le16_to_cpu(generatedLimit);
		Object generatedCount = c.getCount();
		count = .ext2fs_le16_to_cpu(generatedCount);
		if (count_offset + (limit * ) > fs.getBlocksize() - ) {
			return 0;
		} 
		...
		return .ext2fs_le32_to_cpu(generatedDt_checksum) == calculated;
	}
	public Object ext2fs_dx_csum_set(Object fs, Object inum) {
		...
		t.setDt_checksum(.ext2fs_cpu_to_le32(crc));
		return retval;
	}

...
public class terminating_extended_area_desc_s {
	private Object struct_type;
	private Object std_id;
	private Object struct_version;
	private Object struct_data;
	
	public terminating_extended_area_desc_s(Object struct_type, Object std_id, Object struct_version, Object struct_data) {
		setStruct_type(struct_type);
		setStd_id(std_id);
		setStruct_version(struct_version);
		setStruct_data(struct_data);
	}
	public terminating_extended_area_desc_s() {
	}

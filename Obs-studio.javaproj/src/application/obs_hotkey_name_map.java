...
public class obs_hotkey_name_map {
	...
	public void obs_hotkey_name_map_insert(Object key, int v) {
		...
		ModernizedCProgram.insert(((Object)0), generatedRoot, key, .strlen(key), v);
	}
	public Object obs_hotkey_name_map_lookup(Object key, int v) {
		if (!trie || !key) {
			return false;
		} 
		...
		for (; i < generatedChildren.getNum(); ) {

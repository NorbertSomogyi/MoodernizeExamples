...
public class obs_lua_source {
	...
	public void source_type_unload() {
		...
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/luaL_unref(generatedScript, LUA_REGISTRYINDEX, generatedFunc_create);
		this.setFunc_create(LUA_REFNIL);
		int generatedFunc_destroy = this.getFunc_destroy();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/luaL_unref(generatedScript, LUA_REGISTRYINDEX, generatedFunc_destroy);
		this.setFunc_destroy(LUA_REFNIL);
		int generatedFunc_get_width = this.getFunc_get_width();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/luaL_unref(generatedScript, LUA_REGISTRYINDEX, generatedFunc_get_width);
		this.setFunc_get_width(LUA_REFNIL);
		int generatedFunc_get_height = this.getFunc_get_height();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/luaL_unref(generatedScript, LUA_REGISTRYINDEX, generatedFunc_get_height);
		this.setFunc_get_height(LUA_REFNIL);
		int generatedFunc_get_defaults = this.getFunc_get_defaults();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/luaL_unref(generatedScript, LUA_REGISTRYINDEX, generatedFunc_get_defaults);
		this.setFunc_get_defaults(LUA_REFNIL);
		int generatedFunc_get_properties = this.getFunc_get_properties();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/luaL_unref(generatedScript, LUA_REGISTRYINDEX, generatedFunc_get_properties);
		this.setFunc_get_properties(LUA_REFNIL);
		int generatedFunc_update = this.getFunc_update();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/luaL_unref(generatedScript, LUA_REGISTRYINDEX, generatedFunc_update);
		this.setFunc_update(LUA_REFNIL);
		int generatedFunc_activate = this.getFunc_activate();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/luaL_unref(generatedScript, LUA_REGISTRYINDEX, generatedFunc_activate);
		this.setFunc_activate(LUA_REFNIL);
		int generatedFunc_deactivate = this.getFunc_deactivate();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/luaL_unref(generatedScript, LUA_REGISTRYINDEX, generatedFunc_deactivate);
		this.setFunc_deactivate(LUA_REFNIL);
		int generatedFunc_show = this.getFunc_show();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/luaL_unref(generatedScript, LUA_REGISTRYINDEX, generatedFunc_show);
		this.setFunc_show(LUA_REFNIL);
		int generatedFunc_hide = this.getFunc_hide();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/luaL_unref(generatedScript, LUA_REGISTRYINDEX, generatedFunc_hide);
		this.setFunc_hide(LUA_REFNIL);
		int generatedFunc_video_tick = this.getFunc_video_tick();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/luaL_unref(generatedScript, LUA_REGISTRYINDEX, generatedFunc_video_tick);
		this.setFunc_video_tick(LUA_REFNIL);
		int generatedFunc_video_render = this.getFunc_video_render();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/luaL_unref(generatedScript, LUA_REGISTRYINDEX, generatedFunc_video_render);
		this.setFunc_video_render(LUA_REFNIL);
		int generatedFunc_save = this.getFunc_save();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/luaL_unref(generatedScript, LUA_REGISTRYINDEX, generatedFunc_save);
		this.setFunc_save(LUA_REFNIL);
		int generatedFunc_load = this.getFunc_load();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/luaL_unref(generatedScript, LUA_REGISTRYINDEX, generatedFunc_load);

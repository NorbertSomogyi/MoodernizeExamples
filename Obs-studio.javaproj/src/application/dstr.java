...
public class dstr {
	...
	public void dstr_init_move_array(Byte str) {
		this.setArray(str);
		this.setLen((!str) ? 0 : /*Error: Function owner not recognized*/strlen(str));
	...
	public void dstr_copy_dstr(Object src) {
		...
		if (src.getLen()) {
			...
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(generatedArray, generatedArray, src.getLen() + 1);
	...
	public void dstr_cat(Object array) {
		...
		len = /*Error: Function owner not recognized*/strlen(array);
	...
	public Object get_key_translation(Object keycode) {
		...
		connection = /*Error: Function owner not recognized*/XGetXCBConnection(ModernizedCProgram.obs.getHotkeys().getPlatform_context().getDisplay());
		 event = new (0);
		...
		if (keycode) {
			int len = /*Error: Function owner not recognized*/XLookupString(event, name, 128, ((Object)0), ((Object)0));
			if (len) {
	...
	public void obs_key_to_str(obs_key key) {
		...
		Object generatedLayout = plat.getLayout();
		 err = /*Error: Function owner not recognized*/UCKeyTranslate(generatedLayout, code, kUCKeyActionDown, -1024, /*Error: Function owner not recognized*/LMGetKbdType(), kUCKeyTranslateNoDeadKeysBit, dead_key_state, max_length, len, buffer);
		if (err == noErr && len <= 0 && dead_key_state) {
			err = /*Error: Function owner not recognized*/UCKeyTranslate(generatedLayout, kVK_Space, kUCKeyActionDown, -1024, /*Error: Function owner not recognized*/LMGetKbdType(), kUCKeyTranslateNoDeadKeysBit, dead_key_state, max_length, len, buffer);
		} 
		...
		if (len == 0) {
		 ...
		 string = /*Error: Function owner not recognized*/CFStringCreateWithCharactersNoCopy(NULL, buffer, len, kCFAllocatorNull);
		if (!string) {
		...
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/CFRelease(string);
		return /*Error: Unsupported expression*/;
		wchar_t[] name = L"";
		...
		scan_code = /*Error: Function owner not recognized*/MapVirtualKeyA(vk, 0) << 16;
		switch (vk) {
		case 35:
		case 46:
		case 34:
		...
		if (scan_code != 0 && /*Error: Function owner not recognized*/GetKeyNameTextW(scan_code, name, 128) != 0) {
	...
	public Object dstr_from_cfstring(Object ref) {
		 length = /*Error: Function owner not recognized*/CFStringGetLength(ref);
		 max_size = /*Error: Function owner not recognized*/CFStringGetMaximumSizeForEncoding(length, kCFStringEncodingUTF8);
		str.dstr_reserve(max_size);
		Object generatedDstr = this.getDstr();
		if (!/*Error: Function owner not recognized*/CFStringGetCString(ref, generatedDstr, max_size, kCFStringEncodingUTF8)) {
			return false;
		} 
		this.setDstr(/*Error: Function owner not recognized*/strlen(generatedDstr));
		return true;
	}
	...
	public Object code_to_str(int code) {
		...
		case kVK_RightOption:
				str.dstr_from_wcs(/*Error: Unsupported expression*/);
				return true;
		case kVK_F20:
				str.dstr_copy("F20");
				return true;
	...
	public Object get_window_exe(Object window) {
		...
		byte slash;
		DWORD id = new DWORD();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/GetWindowThreadProcessId(window, id);
		if (id == /*Error: Function owner not recognized*/GetCurrentProcessId()) {
			return false;
		} 
		...
		if (!/*Error: Function owner not recognized*/GetProcessImageFileNameW(process, wname, 260)) {
			;
		} 
	...
	public void get_window_title(Object hwnd) {
		...
		int len;
		len = /*Error: Function owner not recognized*/GetWindowTextLengthW(hwnd);
		if (!len) {
			return /*Error: Unsupported expression*/;
		} 
		temp = /*Error: Function owner not recognized*/malloc(/*Error: Unsupported expression*/ * (len + 1));
		if (/*Error: Function owner not recognized*/GetWindowTextW(hwnd, temp, len + 1)) {
	...
	public void get_window_class(Object hwnd) {
		wchar_t[] temp = new wchar_t();
		temp[0] = 0;
		if (/*Error: Function owner not recognized*/GetClassNameW(hwnd, temp, /*Error: sizeof expression not supported yet*/ / /*Error: Unsupported expression*/)) {
	...
	public void dstr_copy(Object array) {
		...
		byte[] generatedArray = this.getArray();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(generatedArray, array, len + 1);
		this.setLen(len);
	}
	...
	public void dstr_cat_dstr(Object str) {
		...
		byte[] generatedArray = this.getArray();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(generatedArray + generatedLen, generatedArray, generatedLen + 1);
		this.setLen(new_len);
	}
	...
	public void dstr_ncat(Object array, Object len) {
		...
		dst.dstr_ensure_capacity(new_len + 1);
		byte[] generatedArray = this.getArray();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(generatedArray + generatedLen, array, len);
		this.setLen(new_len);
	...
	public void dstr_ncat_dstr(Object str, Object len) {
		...
		dst.dstr_ensure_capacity(new_len + 1);
		byte[] generatedArray = this.getArray();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(generatedArray + generatedLen, generatedArray, in_len);
		this.setLen(new_len);
		generatedArray[new_len] = 0;
	}
	public void dstr_insert(Object idx, Object array) {
		...
		dst.dstr_ensure_capacity(new_len + 1);
		byte[] generatedArray = this.getArray();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memmove(generatedArray + idx + len, generatedArray + idx, generatedLen - idx + 1);
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(generatedArray + idx, array, len);
		this.setLen(new_len);
	}
	public void dstr_insert_dstr(Object idx, Object str) {
		...
		dst.dstr_ensure_capacity((new_len + 1));
		byte[] generatedArray = this.getArray();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memmove(generatedArray + idx + generatedLen, generatedArray + idx, generatedLen - idx + 1);
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(generatedArray + idx, generatedArray, generatedLen);
		this.setLen(new_len);
	}
	public void dstr_insert_ch(Object idx, Object ch) {
		...
		dst.dstr_ensure_capacity((++generatedLen + 1));
		byte[] generatedArray = this.getArray();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memmove(generatedArray + idx + 1, generatedArray + idx, generatedLen - idx + 1);
	...
	public void dstr_remove(Object idx, Object count) {
		...
		if (end == generatedLen) {
			generatedArray[idx] = 0;
				...
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memmove(generatedArray + idx, generatedArray + end, generatedLen - end + 1);
		} 
		generatedLen -= count;
	}
	...
	public void dstr_vprintf(Object format, Object args) {
		...
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/__builtin_va_copy(args_cp, args);
		int len = /*Error: Function owner not recognized*/vsnprintf(((Object)0), 0, format, args_cp);
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/__builtin_va_end(args_cp);
		if (len < 0) {
			len = 4095;
		} 
		dst.dstr_ensure_capacity(((size_t)len) + 1);
		byte[] generatedArray = this.getArray();
		len = /*Error: Function owner not recognized*/vsnprintf(generatedArray, ((size_t)len) + 1, format, args);
		if (!generatedArray) {
			dst.dstr_free();
			return /*Error: Unsupported expression*/;
		} 
		this.setLen(len < 0 ? /*Error: Function owner not recognized*/strlen(generatedArray) : (size_t)len);
	}
	public void dstr_vcatf(Object format, Object args) {
		...
		byte[] generatedArray = this.getArray();
		len = /*Error: Function owner not recognized*/vsnprintf(generatedArray + generatedLen, ((size_t)len) + 1, format, args);
		if (!generatedArray) {
			dst.dstr_free();
			return /*Error: Unsupported expression*/;
		} 
		generatedLen += len < 0 ? /*Error: Function owner not recognized*/strlen(generatedArray + generatedLen) : (size_t)len;
	}
	...
	public void dstr_replace(Object find, Object replace) {
		...
		find_len = /*Error: Function owner not recognized*/strlen(find);
		replace_len = /*Error: Function owner not recognized*/strlen(replace);
		byte[] generatedArray = this.getArray();
		temp = generatedArray;
		Object generatedLen = this.getLen();
		if (replace_len < find_len) {
			long count = 0;
			while ((temp = /*Error: Function owner not recognized*/strstr(temp, find)) != ((Object)0)) {
				byte end = temp + find_len;
				size_t end_len = /*Error: Function owner not recognized*/strlen(end);
				if (end_len) {
					/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memmove(temp + replace_len, end, end_len + 1);
					if (replace_len) {
						/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(temp, replace, replace_len);
					} 
				} else {
						/*Error: Function owner not recognized*//*Error: Function owner not recognized*/strcpy(temp, replace);
				} 
				temp += replace_len;
				++count;
			}
	...
	public void dstr_depad() {
		...
		if (generatedArray) {
			...
			if (generatedArray) {
				this.setLen(/*Error: Function owner not recognized*/strlen(generatedArray));
			} else {
					str.dstr_free();
			} 
		} 
	...
	public void dstr_left(Object str, Object pos) {
		...
		byte[] generatedArray = this.getArray();
		if (dst != str) {
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(generatedArray, generatedArray, pos);
		} 
	}
	...
	public void dstr_from_wcs(Object wstr) {
		size_t len = /*Error: Function owner not recognized*/wchar_to_utf8(wstr, 0, ((Object)0), 0, 0);
		byte[] generatedArray = this.getArray();
		if (len) {
			dst.dstr_resize(len);
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/wchar_to_utf8(wstr, 0, generatedArray, len + 1, 0);
		} else {
				dst.dstr_free();
		} 
	}
	public void dstr_to_upper() {
		...
		while (temp) {
			temp = (wchar_t)/*Error: Function owner not recognized*/towupper(temp);
			temp++;
		}
	...
	public void dstr_to_lower() {
		...
		while (temp) {
			temp = (wchar_t)/*Error: Function owner not recognized*/towlower(temp);
			temp++;
		}
		str.dstr_from_wcs(wstr);
		ModernizedCProgram.bfree(wstr);
	...
	public void dump_csv_fwrite(Object data) {
		byte[] generatedArray = this.getArray();
		Object generatedLen = this.getLen();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/fwrite(generatedArray, 1, generatedLen, data);
	}
	public void dump_csv_gzwrite(Object data) {
		byte[] generatedArray = this.getArray();
		Object generatedLen = this.getLen();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/gzwrite(data, generatedArray, (int)generatedLen);
	}

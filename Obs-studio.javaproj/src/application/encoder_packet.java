...
public class encoder_packet {
	...
	public void insert_packet(Object array, Object video_offset, Object[] audio_offsets, Object video_dts_offset, Object[] audio_dts_offsets) {
		...
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/da_insert(packets, idx, pkt);
		array = packets.getDa();
	}
	...
	public void obs_parse_avc_packet(Object src) {
		...
		avc_packet = src;
		s.serialize(ref, /*Error: sizeof expression not supported yet*/);
		Object generatedKeyframe = this.getKeyframe();
		...
		this.setData(generatedArray_output_data.getArray() + /*Error: sizeof expression not supported yet*/);
		this.setSize(generatedArray_output_data.getNum() - /*Error: sizeof expression not supported yet*/);
	...
	public void default_encoded_callback(Object param) {
		...
		if (output.data_active()) {
			...
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(generatedData, packet);
			if (generatedType == obs_encoder_type.OBS_ENCODER_VIDEO) {
	...
	******************************************************************************/
	...
	public Object nvenc_encode_tex(Object data, Object handle, Object pts, Object lock_key, Object next_key, Object received_packet) {
		...
		generatedDts_list.circlebuf_push_back(pts, /*Error: sizeof expression not supported yet*/);
		Object generatedEvent = bs.getEvent();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/WaitForSingleObject(generatedEvent, /* wait for output bitstream/tex        */-1024/* ------------------------------------ */);
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(km, lock_key, /* copy to output tex                   */-1024);
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(context, ()output_tex, ()input_tex);
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(km, next_key/* ------------------------------------ */);
		...
		if (enc.nv_failed(/*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(generatedSession, map), __FUNCTION__, "nv.nvEncMapInputResource(enc->session, &map)")) {
			return false;
		} 
		...
		err = /*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(generatedSession, params);
		...
		if (generatedPacket_data.getNum()) {
			 dts = new ();
			generatedDts_list.circlebuf_pop_front(dts, /*Error: sizeof expression not supported yet*/);
			if (generatedBframes) {
	...
	******************************************************************************/
	public Object get_ms_time(Object val) {
		Object generatedTimebase_den = this.getTimebase_den();
		return /*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(val * 1000 / generatedTimebase_den);
	}
	public void obs_encoder_packet_create_instance(Object src) {
		long p_refs;
		dst = src;
		p_refs = ModernizedCProgram.bmalloc(src.getSize() + /*Error: Unsupported expression*/);
		this.setData((Object)(p_refs + 1));
		p_refs = 1;
		Object generatedData = this.getData();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memcpy(generatedData, generatedData, src.getSize());
	}
	...
	public void obs_encoder_packet_release() {
		...
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memset(pkt, 0, /*Error: Unsupported expression*/);
	}
	public void null_output_data(Object data) {
		...
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/UNUSED_PARAMETER(packet);
	}

...
public class condstack {
	 ...
	 */
	public void rewind_conditionals(int idx, int cond_type, Integer cond_level) {
		int generatedCs_idx = this.getCs_idx();
		Object generatedCs_flags = this.getCs_flags();
	...
	public Object do_one_cmd(Object cmdlinep, int sourcing, Object fgetline, Object cookie) {
		...
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memset((ea), (false), (/*Error: sizeof expression not supported yet*/));
		ea.setLine1(1);
		ea.setLine2(1);
		++ex_nesting_level;
		...
		p = ModernizedCProgram.find_command(ea, ((Object)0));
		...
		if (p != ((Object)0) && generatedCmdidx == CMD_index.CMD_SIZE && !generatedSkip && ((int)(generatedCmd) - (byte)'A' < 26) && ModernizedCProgram.has_cmdundefined()) {
			...
			p = (ret && !ModernizedCProgram.aborting()) ? ModernizedCProgram.find_command(ea, ((Object)0)) : generatedCmd;
		} 
		if (p == ((Object)0)) {
			if (!generatedSkip) {
		...
		if (generatedCmdidx == CMD_index.CMD_SIZE) {
			if (!generatedSkip) {
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/strcpy((byte)(ModernizedCProgram.IObuff), (byte)(((byte)("E492: Not an editor command"))));
				if (!sourcing) {
		...
		if (((int)(generatedCmdidx) < 0/*
			...
			ea.do_ucmd();
				...
				ea.setErrmsg(((Object)/*
					 ...
					 */0));
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(ea);
		...
		if (errormsg != ((Object)0) && errormsg != (byte)'\000' && !ModernizedCProgram.did_emsg) {
			if (sourcing) {
				if (errormsg != (byte)ModernizedCProgram.IObuff) {
					/*Error: Function owner not recognized*//*Error: Function owner not recognized*/strcpy((byte)(ModernizedCProgram.IObuff), (byte)(errormsg));
					errormsg = (byte)ModernizedCProgram.IObuff;
				} 
				ModernizedCProgram.append_command(cmdlinep);
			} 

...
public class oparg_S {
	...
	public void op_shift(int curs_top, int amount) {
		...
		for (i = generatedLine_count; --i >= 0; /*Error: Unsupported expression*/) {
		...
		generatedB_op_end.setCol((colnr_T)/*Error: Function owner not recognized*/strlen((byte)(ModernizedCProgram.ml_get(generatedLnum))));
	...
	public void shift_block(int amount) {
		...
		if (!left/*
			...
			if (generatedStartspaces) {
				if (has_mbyte) {
					if (/*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(generatedTextstart) == 1) {
						++generatedTextstart;
					} else {
							ws_vcol = 0;
							bd.setStartspaces(0);
			...
			for (; ((generatedTextstart) == (byte)' ' || (generatedTextstart) == (byte)'\t'); /*Error: Unsupported expression*/) {
			...
			len = (int)/*Error: Function owner not recognized*/strlen((byte)(generatedTextstart)) + 1;
			newp = ModernizedCProgram.alloc(generatedTextcol + i + j + len);
			if (newp == ((Object)0)) {
				return /*Error: Unsupported expression*/;
			} 
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memset((newp), ((byte)'\000'), ((size_t)(generatedTextcol + i + j + len)));
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memmove((byte)(newp), (byte)(oldp), (size_t)((size_t)generatedTextcol));
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memset((newp + generatedTextcol), ((byte)'\011'), ((size_t)i));
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memset((newp + generatedTextcol + i), ((byte)' '), ((size_t)j));
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memmove((byte)(newp + generatedTextcol + i + j), (byte)(generatedTextstart), (size_t)((size_t)/* the end */len/* left */));
		} else {
				...
				if (generatedStartspaces) {
					non_white += /*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(non_white);
				} 
				...
				while (verbatim_copy_width < destination_col) {
					...
					verbatim_copy_end += /*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(verbatim_copy_end);
				}
				...
				new_line_len = (int)(verbatim_copy_end - oldp) + fill + (int)/*Error: Function owner not recognized*/strlen((byte)(non_white)) + 1;
				newp = ModernizedCProgram.alloc(new_line_len);
				if (newp == ((Object)0)) {
					return /*Error: Unsupported expression*/;
				} 
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memmove((byte)(newp), (byte)(oldp), (size_t)((size_t)(verbatim_copy_end - oldp)));
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memset((newp + (verbatim_copy_end - oldp)), ((byte)' '), ((size_t)fill));
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memmove((byte)((newp + (verbatim_copy_end - oldp) + fill)), (byte)((non_white)), (size_t)(/*Error: Function owner not recognized*/strlen((byte)(non_white)) + 1));
		} 
	...
	public int op_delete() {
		...
		if (generatedBlock_mode) {
			...
			for (lnum = generatedLnum; lnum <= generatedLnum; ++lnum) {
				...
				newp = ModernizedCProgram.alloc(/*Error: Function owner not recognized*/strlen((byte)(oldp)) + 1 - n);
				if (newp == ((Object)0)) {
					continue;
				} 
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memmove((byte)(newp), (byte)(oldp), (size_t)((size_t)generatedTextcol));
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memset((newp + generatedTextcol), ((byte)' '), ((size_t)(generatedStartspaces + generatedEndspaces)));
				oldp += generatedTextcol + generatedTextlen;
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memmove((byte)((newp + generatedTextcol + generatedStartspaces + generatedEndspaces)), (byte)((oldp)), (size_t)(/*Error: Function owner not recognized*/strlen((byte)(oldp)) + 1));
			...
			if (generatedOp_type == 3/* Delete the lines except the first one.  Temporarily move the
				...
				if (generatedLine_count == /* delete characters within one line */1) {
					...
					if (virtual_op/* fix up things for virtualedit-delete:
						...
						int len = (int)/*Error: Function owner not recognized*/strlen((byte)(curline));
	...
	public int op_replace(int c) {
		...
		if (generatedBlock_mode) {
			...
			for (; generatedLnum <= generatedLnum; ++generatedLnum) {
				...
				if (/*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(c) > /* A double-wide character can be replaced only up to half the
					     * times. */1) {
				...
				numc *= /*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(c);
				n += numc - generatedTextlen;
				oldp = ModernizedCProgram.ml_get_curline();
				oldlen = /*Error: Function owner not recognized*/strlen((byte)(oldp));
				newp = ModernizedCProgram.alloc(oldlen + 1 + n);
				if (newp == ((Object)0)) {
					continue;
				} 
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memset((newp), ((byte)'\000'), ((size_t)(oldlen + 1 + n)));
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memmove((byte)(newp), (byte)(oldp), (size_t)((size_t)generatedTextcol));
				oldp += generatedTextcol + generatedTextlen;
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memset((newp + generatedTextcol), ((byte)' '), ((size_t)generatedStartspaces));
				if (had_ctrl_v_cr || (c != (byte)'\r' && c != /* REPLACE_CR_NCHAR/REPLACE_NL_NCHAR is used for entering CR
					     * literally. */(byte)'\n')) {
					if (has_mbyte) {
						n = (int)/*Error: Function owner not recognized*/strlen((byte)(newp));
						while (--num_chars >= 0) {
							n += /*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(c, newp + n);
						}
					} else {
							/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memset((newp + /*Error: Function owner not recognized*/strlen((byte)(newp))), (c), ((size_t)numc));
					} 
					if (!generatedIs_short) {
						/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memset((newp + /*Error: Function owner not recognized*/strlen((byte)(newp))), ((byte)' '), ((size_t)generatedEndspaces));
						/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memmove((byte)((newp + /*Error: Function owner not recognized*/strlen((byte)(newp)))), (byte)((oldp)), (size_t)(/*Error: Function owner not recognized*/strlen((byte)(oldp)) + /* copy the part after the changed part */1));
					} 
				} else {
						after_p = ModernizedCProgram.alloc(oldlen + 1 + n - /*Error: Function owner not recognized*/strlen((byte)(/* Replacing with \r or \n means splitting the line. */newp)));
						if (after_p != ((Object)0)) {
							/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memmove((byte)((after_p)), (byte)((oldp)), (size_t)(/*Error: Function owner not recognized*/strlen((byte)(oldp)) + 1));
						} 
				} 
				...
				while ((((generatedLnum != generatedLnum) ? generatedLnum < generatedLnum : generatedCol != generatedCol ? generatedCol < generatedCol : generatedColadd < generatedColadd) || ((generatedLnum == generatedLnum) && (generatedCol == generatedCol) && (generatedColadd == generatedColadd)))) {
					...
					if (n != (byte)'\000') {
						if (/*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(c) > 1 || /*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(n) > 1) {
							if (generatedLnum == generatedLnum) {
								generatedCol += /*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(c) - /*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(n);
							} 
						...
						for (; virtcols >= 0; virtcols--) {
							if (/*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(c) > 1) {
								ModernizedCProgram.replace_character(c);
							} else {
									((curbuf.ml_get_buf(generatedLnum, 1) + generatedCol) = (c));
							} 
				...
				if (generatedLnum == generatedLnum) {
					did_change = pos.swapchars(generatedOp_type, generatedCol - generatedCol + 1);
						...
						for (; /*Error: Unsupported expression*/; /*Error: Unsupported expression*/) {
							did_change |=  pos.swapchars(generatedOp_type, generatedLnum == generatedLnum ? generatedCol + 1 : (int)/*Error: Function owner not recognized*/strlen((byte)(pos.ml_get_pos())));
	...
	public void op_insert(long count1) {
		...
		if (generatedBlock_mode) {
			...
			pre_textlen = (long)/*Error: Function owner not recognized*/strlen((byte)(firstline));
		} 
		int generatedIs_short = bd.getIs_short();
		int generatedIs_MAX = bd.getIs_MAX();
		int generatedEndspaces = bd.getEndspaces();
		...
		if (generatedBlock_mode) {
			...
			len = /*Error: Function owner not recognized*/strlen((byte)(firstline));
			...
			if (pre_textlen >= 0 && (ins_len = (long)/*Error: Function owner not recognized*/strlen((byte)(firstline)) - pre_textlen) > 0) {
	...
	public int op_change() {
		...
		if (generatedBlock_mode && generatedLnum != generatedLnum && !got_int) {
			...
			ins_len = (long)/*Error: Function owner not recognized*/strlen((byte)(firstline)) - pre_textlen;
			if (ins_len > 0) {
				if ((ins_text = ModernizedCProgram.alloc(ins_len + 1)) != ((Object)/* Subsequent calls to ml_get() flush the firstline data - take a
					...
					for (linenr = generatedLnum + 1; linenr <= generatedLnum; linenr++) {
						...
						if (!generatedIs_short || virtual_op) {
							...
							newp = ModernizedCProgram.alloc(/*Error: Function owner not recognized*/strlen((byte)(oldp)) + generatedColadd + ins_len + 1);
							if (newp == ((Object)0)) {
								continue;
							} 
							/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memmove((byte)(newp), (byte)(oldp), (size_t)((size_t)generatedTextcol));
							offset = generatedTextcol;
							/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memset((newp + offset), ((byte)' '), ((size_t)generatedColadd));
							offset += generatedColadd;
							/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memmove((byte)(newp + offset), (byte)(ins_text), (size_t)((size_t)ins_len));
							offset += ins_len;
							oldp += generatedTextcol;
							/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memmove((byte)((newp + offset)), (byte)((oldp)), (size_t)(/*Error: Function owner not recognized*/strlen((byte)(oldp)) + 1));
			...
			if (change_cnt) {
				...
				for (; generatedLnum <= generatedLnum; ++generatedLnum) {
					if (generatedBlock_mode) {
						...
						ModernizedCProgram.curwin.getW_cursor().setCol(0);
						pos.setCol(0);
						length = (colnr_T)/*Error: Function owner not recognized*/strlen((byte)(ModernizedCProgram.ml_get(generatedLnum)));
					} else {
							...
							if (generatedLnum == generatedLnum) {
								length = (int)/*Error: Function owner not recognized*/strlen((byte)(ModernizedCProgram.ml_get(generatedLnum)));
	...
	public void clear_oparg() {
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memset((oap), (false), (/*Error: Unsupported expression*//*
	...
	public void op_reindent(Object how) {
		...
		long generatedLine_count = this.getLine_count();
		for (i = generatedLine_count; --i >= 0 && !got_int; /*Error: Unsupported expression*/) {
			...
			if (i != generatedLine_count - 1 || generatedLine_count == 1 || how != get_lisp_indent) {
				...
				if (l == (byte)'\000') {
					amount = 0;
						...
						amount = /*Error: Function owner not recognized*/how();
				} 
	...
	public int op_yank(int deleting, int mess) {
		...
		ModernizedCProgram.y_current.setY_array(ModernizedCProgram.lalloc_clear(/*Error: Unsupported expression*/ * yanklines, 1));
					...
					{ 
						...
						if (lnum == generatedLnum) {
							...
							if (virtual_op) {
								...
								if (p[endcol] == (byte)'\000' || (cs + generatedColadd < ce && /*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(p, p + endcol) == 0)) {
						...
						if (endcol == INT_MAX) {
							endcol = (colnr_T)/*Error: Function owner not recognized*/strlen((byte)(p));
						} 
		...
		// append the new block to the old blockif (curr != ModernizedCProgram.y_current) {
			new_ptr = (char_u)ModernizedCProgram.alloc(/*Error: Unsupported expression*/ * (generatedY_size + generatedY_size));
			if (new_ptr == ((Object)0)) {
				;
			} 
			...
			if (generatedY_type == 0 && ModernizedCProgram.vim_strchr(ModernizedCProgram.p_cpo, (byte)'>') == ((Object)0)) {
				pnew = ModernizedCProgram.alloc(/*Error: Function owner not recognized*/strlen((byte)(generatedY_array[generatedY_size - 1])) + /*Error: Function owner not recognized*/strlen((byte)(generatedY_array[0])) + 1);
				if (pnew == ((Object)0)) {
					y_idx = generatedY_size - 1;
					;
				} 
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/strcpy((byte)(pnew), (byte)(generatedY_array[--j]));
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/strcat((byte)(pnew), (byte)(generatedY_array[0]));
			...
			if (yanklines > ModernizedCProgram.p_report) {
				...
				if (generatedRegname == (byte)'\000') {
					namebuf = (byte)'\000';
						...
						ModernizedCProgram.vim_snprintf(namebuf, /*Error: sizeof expression not supported yet*/, ((byte)(" into \"%c")), generatedRegname);
				} 
	...
	public void normal_cmd(int toplevel) {
		...
		int idx;
		int set_prevcount = 0;
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/memset((ca), (false), (/*Error: sizeof expression not supported yet*/));
		...
		idx = ModernizedCProgram.find_command(generatedCmdchar);
		if (idx < 0) {
		...
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(ca/*
		...
		if (((ModernizedCProgram.p_smd && msg_silent == 0 && (restart_edit != 0 || (VIsual_active && generatedLnum == generatedLnum && generatedCol == generatedCol)) && (clear_cmdline || redraw_cmdline) && (msg_didout || (msg_didany && msg_scroll)) && !msg_nowait && ModernizedCProgram.KeyTyped) || (restart_edit != 0 && !VIsual_active && (msg_scroll || emsg_on_display))) && generatedRegname == 0 && !(generatedRetval & 1) && ModernizedCProgram.stuff_empty() && ModernizedCProgram.typebuf_typed() && emsg_silent == 0 && !did_wait_return && generatedOp_type == 0) {
			...
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/setcursor();
			...
			if (findc == (byte)'\000') {
					...
					hash_dir = dir/*
						...
						if (!cpo_match) {
							...
							if (ptr == (byte)'#' && generatedCol <= (colnr_T)(ptr - linep)) {
								...
								if (/*Error: Function owner not recognized*/strncmp((byte)(ptr), (byte)("if"), (size_t)(true)) == 0 || /*Error: Function owner not recognized*/strncmp((byte)(ptr), (byte)("endif"), (size_t)(true)) == 0 || /*Error: Function owner not recognized*/strncmp((byte)(ptr), (byte)("el"), (size_t)(true)) == 0) {
									hash_dir = 1;
								} 
						...
						if (!hash_dir && !/*
							...
							for (; /*Error: Unsupported expression*/; /*Error: Unsupported expression*/) {
								initc = (has_mbyte ? /*Error: Function owner not recognized*/mb_ptr2char(linep + generatedCol) : (int)(linep + generatedCol));
								if (initc == (byte)'\000') {
									break;
								} 
								...
								generatedCol += /*Error: Function owner not recognized*/mb_ptr2len(linep + generatedCol);
							}
							if (!findc) {
								...
								for (col = generatedCol; ModernizedCProgram.check_prevcol(linep, col, (byte)'\\', /* Set "match_escaped" if there are an odd number of
										     * backslashes. */col); /*Error: Unsupported expression*/) {
									bslcnt++;
								}
				...
				if (hash_dir/*
					...
					if (initc != (byte)'#') {
						...
						if (/*Error: Function owner not recognized*/strncmp((byte)(ptr), (byte)("if"), (size_t)(true)) == 0 || /*Error: Function owner not recognized*/strncmp((byte)(ptr), (byte)("el"), (size_t)(true)) == 0) {
							hash_dir = 1;
						}  else if (/*Error: Function owner not recognized*/strncmp((byte)(ptr), (byte)("endif"), (size_t)(true)) == 0) {
							hash_dir = -1;
						} else {
								return ((Object)0);
						} 
					...
					while (!got_int) {
						...
						ptr = ModernizedCProgram.skipwhite(ptr + 1);
						if (hash_dir > 0) {
							if (/*Error: Function owner not recognized*/strncmp((byte)(ptr), (byte)("if"), (size_t)(true)) == 0) {
								count++;
							}  else if (/*Error: Function owner not recognized*/strncmp((byte)(ptr), (byte)("el"), (size_t)(true)) == 0) {
								if (count == 0) {
									return pos;
								} 
							}  else if (/*Error: Function owner not recognized*/strncmp((byte)(ptr), (byte)("endif"), (size_t)(true)) == 0) {
								...
								if (/*Error: Function owner not recognized*/strncmp((byte)(ptr), (byte)("if"), (size_t)(true)) == 0) {
									...
									count--;
								}  else if (initc == (byte)'#' && /*Error: Function owner not recognized*/strncmp((byte)(ptr), (byte)("el"), (size_t)(true)) == 0) {
									if (count == 0) {
										return pos;
									} 
								}  else if (/*Error: Function owner not recognized*/strncmp((byte)(ptr), (byte)("endif"), (size_t)(true)) == 0) {
		...
		while (!got_int/*
			...
			if (backwards) {
				...
				if (generatedCol == /* at start of line, go to prev. one */0) {
					...
					linep = ModernizedCProgram.ml_get(generatedLnum);
					pos.setCol((colnr_T)/*Error: Function owner not recognized*/strlen((byte)(/* pos.col on trailing NUL */linep)));
					do_quotes = -1;
					ModernizedCProgram.line_breakcheck();
					...
					if (lisp && comment_col != /* skip comment */INT_MAX) {
						...
						--generatedCol;
						if (has_mbyte) {
							generatedCol -= /*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(linep, linep + generatedCol);
						} 
				} 
			} else {
					if (linep[generatedCol] == /* forward search */(byte)'\000'/* at end of line, go to next one */ || (lisp && comment_col != /* don't search for match in comment */INT_MAX && generatedCol == (colnr_T)comment_col)) {
						...
						if (/* find comment pos in new line */lisp) {
							...
							if (has_mbyte) {
								generatedCol += /*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(linep + generatedCol);
							} else {
									++generatedCol;
							} 
					} 
			...
			if (cpo_match) {
				...
				if (!do_quotes) {
					...
					if (generatedLnum > 1) {
						...
						if (ptr && (ptr + /*Error: Function owner not recognized*/strlen((byte)(ptr)) - 1) == (byte)'\\') {
							do_quotes = 1;
							if (start_in_quotes == 2) {
								inquote = at_start;
								if (inquote) {
			...
			c = (has_mbyte ? /*Error: Function owner not recognized*/mb_ptr2char(linep + generatedCol) : (int)(linep + generatedCol));
			switch (c) {
			case (byte)'\000':
			...
			default:
					...
					if ((!inquote || start_in_quotes == /* Check for match outside of quotes, and inside of
						...
						int bslcnt = 0;
						if (!cpo_bsl) {
							for (col = generatedCol; ModernizedCProgram.check_prevcol(linep, col, (byte)'\\', col); /*Error: Unsupported expression*/) {
								bslcnt++;
							}
						} 
	...
	public int current_tagblock(long count_arg, int include) {
		...
		for (cp = p; cp != (byte)'\000' && cp != (byte)'>' && !((cp) == (byte)' ' || (cp) == (byte)'\t'); cp += /*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(cp)) {
			;
		}
		len = (int)(cp - p);
		if (len == 0) {
		...
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/sprintf((byte)spat, "<%.*s\\>\\%%(\\s\\_[^>]\\{-}[^/]>\\|>\\)\\c", len, p);
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/sprintf((byte)epat, "</%.*s>\\c", len, p);

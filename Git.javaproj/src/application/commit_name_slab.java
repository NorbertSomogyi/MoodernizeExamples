...
public class commit_name_slab {
	...
	public commit_name_slab() {
	}
	
	public void init_commit_name_slab_with_stride(int stride) {
		int elem_size;
		if (!stride) {
			stride = 1;
		} 
	...
	public void init_commit_name_slab() {
		s.init_commit_name_slab_with_stride(1);
	}

...
public class commit_base {
	private int slab_size;
	private int stride;
	private int slab_count;
	private int slab;
	
	public commit_base(int slab_size, int stride, int slab_count, int slab) {
	...
	public void init_commit_base_with_stride(int stride) {
		int elem_size;
		if (!stride) {
			stride = 1;
		} 
	...
	public void init_commit_base() {
		s.init_commit_base_with_stride(1);
	}
	public void clear_commit_base() {
		int i;
	...
	public Integer commit_base_at_peek(Object c, int add_if_missing) {
		int nth_slab;
		int nth_slot;
	...
	public Integer commit_base_at(Object c) {
		return s.commit_base_at_peek(c, 1);
	}
	public Integer commit_base_peek(Object c) {
		return s.commit_base_at_peek(c, 0);
	}

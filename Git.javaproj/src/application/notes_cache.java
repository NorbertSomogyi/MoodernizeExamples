...
public class notes_cache {
	...
	public int notes_cache_write() {
		...
		if (/*Error: Function owner not recognized*/write_notes_tree(generatedTree, tree_oid)) {
			return -1;
		} 
		Byte generatedValidity = this.getValidity();
		if (/*Error: Function owner not recognized*/commit_tree(generatedValidity, /*Error: Function owner not recognized*/strlen(generatedValidity), tree_oid, ((Object)0), commit_oid, ((Object)0), ((Object)0)) < 0) {
			return -1;
		} 

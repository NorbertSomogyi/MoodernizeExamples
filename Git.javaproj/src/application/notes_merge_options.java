...
public class notes_merge_options {
	...
	public int notes_merge_abort() {
		...
		if (generatedVerbosity >= 3) {
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/printf("Removing notes merge worktree at %s/*\n", generatedBuf);
		} 
	...
	public int merge_commit() {
		...
		}  else if (!(partial = /*Error: Function owner not recognized*/lookup_commit_reference(ModernizedCProgram.the_repository, oid))) {
		...
		t = ModernizedCProgram.xcalloc(1, /*Error: Unsupported expression*/);
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/init_notes(t, "NOTES_MERGE_PARTIAL", ModernizedCProgram.combine_notes_overwrite, 0);
		...
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/free_notes(t);
		msg.strbuf_release();
		ret = o.merge_abort();

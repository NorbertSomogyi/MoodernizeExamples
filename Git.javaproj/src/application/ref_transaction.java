...
public class ref_transaction {
	...
	public ref_transaction ref_store_transaction_begin(ref_store refs, strbuf err) {
		...
		((err) ? (Object)0 : /*Error: Function owner not recognized*/_assert("err", "E:\\Programfiles\\Eclipse\\Workspaces\\runtime-EclipseApplication\\Git\\src\\refs.c", 1077));
		tr = ModernizedCProgram.xcalloc(1, /*Error: Unsupported expression*/);

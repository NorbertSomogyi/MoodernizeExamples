...
public class packing_data {
	...
	public void packing_data_lock() {
		...
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/pthread_mutex_lock(generatedOdb_lock);
	}
	public void packing_data_unlock() {
		Object generatedOdb_lock = this.getOdb_lock();
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/pthread_mutex_unlock(generatedOdb_lock);
	}
	...
	public void setTree_depth(int[] newTree_depth) {

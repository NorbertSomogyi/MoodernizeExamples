...
public class ref_bitmap {
	private int slab_size;
	private int stride;
	private int slab_count;
	private Object slab;
	
	public ref_bitmap(int slab_size, int stride, int slab_count, Object slab) {
	...
	public void init_ref_bitmap_with_stride(int stride) {
		int elem_size;
		if (!stride) {
			stride = 1;
		} 
	...
	public void init_ref_bitmap() {
		s.init_ref_bitmap_with_stride(1);
	}
	public void clear_ref_bitmap() {
		int i;
	...
	public Object ref_bitmap_at_peek(Object c, int add_if_missing) {
		int nth_slab;
		int nth_slot;
	...
	public Object ref_bitmap_at(Object c) {
		return s.ref_bitmap_at_peek(c, 1);
	}
	public Object ref_bitmap_peek(Object c) {
		return s.ref_bitmap_at_peek(c, 0);
	}

...
public class indegree_slab {
	...
	public indegree_slab() {
	}
	
	public void init_indegree_slab_with_stride(int stride) {
		int elem_size;
		if (!stride) {
			stride = 1;
		} 
	...
	public void init_indegree_slab() {
		s.init_indegree_slab_with_stride(1);
	}
	...
	public Integer indegree_slab_at_peek(Object c, int add_if_missing) {
		int nth_slab;
		int nth_slot;
	...
	public Integer indegree_slab_at(Object c) {
		return s.indegree_slab_at_peek(c, 1);
	}
	public Integer indegree_slab_peek(Object c) {
		return s.indegree_slab_at_peek(c, 0);
	}

...
public class ref_array_item {
	...
	public void show_ref_array_item(Object format) {
		strbuf final_buf = new strbuf(/*Error: Invalid initializer*/, /*Error: Invalid initializer*/, /*Error: Invalid initializer*/);
		strbuf error_buf = new strbuf(/*Error: Invalid initializer*/, /*Error: Invalid initializer*/, /*Error: Invalid initializer*/);
		...
		/*Error: Function owner not recognized*//*Error: Function owner not recognized*/fwrite(generatedBuf, 1, generatedLen, (_iob[1]));

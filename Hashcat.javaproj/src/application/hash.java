...
public class hash {
	...
	public int module_hash_init_selftest(Object hashconfig) {
		...
		Object generatedHook_salt = this.getHook_salt();
		hashinfo generatedHash_info = this.getHash_info();
		int parser_status = ModernizedCProgram.module_hash_decode(hashconfig, generatedDigest, generatedSalt, generatedEsalt, generatedHook_salt, generatedHash_info, tmpdata, /*Error: Unsupported expression*/);

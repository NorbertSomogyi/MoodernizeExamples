...
public class ModernizedCProgram {
	...
	public static [] output_fh = new ();
	public static byte[] output_filename;
	...
	public static byte[] title_format_string = "Flickrdf - triples from flickrs %s\n";
	...
	public static [] flickcurl_tags_getClusterPhotos(flickcurl_s[] fc, Object[] tag, Object[] cluster_id, [] list_params) {
		...
		flickcurl_s.flickcurl_add_param(fc, "cluster_id", cluster_id);
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.tags.getClusterPhotos")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		photos_list = flickcurl_s.flickcurl_invoke_photos_list(fc, ()"/rsp/photos", format);
		return photos_list/**
	 ...
	 */
	public static void flickcurl_free_video([] video) {
		do {
			if (!video) {
	...
	public static Object flickcurl_write_callback(Object[] ptr, Object size, Object nmemb, Object[] userdata) {
		...
		if (generatedXml_parse_content) {
			...
			if (rc) {
				flickcurl_s.flickcurl_error(fc, "XML Parsing failed");
			} 
		} 
		return len;
	}
	...
	public static int gettimeofday(timeval[] tp, Object[] tzp) {
		...
		tp.setTv_sec((long)t);
		Object generatedTv_sec = tp.getTv_sec();
		tp.setTv_usec((long)((t - generatedTv_sec) * 1000000.0));
	...
	public static int flickcurl_append_photos_list_params(flickcurl_s[] fc, [] list_params, Object format_p) {
		...
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (generatedExtras) {
			flickcurl_s.flickcurl_add_param(fc, "extras", generatedExtras);
			this_count++;
		} 
		...
		if (generatedFormat) {
			flickcurl_s.flickcurl_add_param(fc, "format", generatedFormat);
			this_count++;
			if (format_p) {
	...
	public static int flickcurl_photos_list_params_init( list_params) {
		if (!list_params) {
			return 1;
		} 
	...
	public static int flickcurl_search_params_init([] params) {
	...
	public static void SHA1Init([] context) {
		Object generatedState = context.getState();
		...
		Object generatedCount = context.getCount();
		generatedCount[0] = generatedCount[1] = 0;
	}
	/* JHB */
	/* Run your data through this. */
	/* JHB */
	public static void SHA1Update([] context, Object[] data, Object len) {
		...
		Object generatedBuffer = context.getBuffer();
		Object generatedState = context.getState();
		if ((j + len) > 63) {
	...
	public static void SHA1Final([] context) {
		/* JHB */uint32_t i = new uint32_t();
		...
		Object generatedDigest = context.getDigest();
		Object generatedState = context.getState();
		for (i = 0; i < 20; i++) {
	...
	public static [] flickcurl_people_getPublicPhotos_params(flickcurl_s[] fc, Object[] user_id, [] list_params) {
		...
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_add_param(fc, "user_id", /* API parameters */user_id);
		ModernizedCProgram.flickcurl_append_photos_list_params(fc, list_params, /* Photos List parameters */format);
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.people.getPublicPhotos")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		photos_list = flickcurl_s.flickcurl_invoke_photos_list(fc, ()"/rsp/photos", format);
	...
	public static [] flickcurl_people_getPhotos_params(flickcurl_s[] fc, Object[] user_id, int safe_search, Object[] min_upload_date, Object[] max_upload_date, Object[] min_taken_date, Object[] max_taken_date, int content_type, int privacy_filter, [] list_params) {
		...
		if (safe_search >= 0 && safe_search < 10) {
			...
			flickcurl_s.flickcurl_add_param(fc, "safe_search", safe_search_s);
		} 
		if (min_upload_date) {
		...
		if (content_type >= 0 && content_type < 10) {
			...
			flickcurl_s.flickcurl_add_param(fc, "content_type", content_type_s);
		} 
		if (privacy_filter >= 0 && privacy_filter < 10) {
			.sprintf(privacy_filter_s, "%d", privacy_filter);
			flickcurl_s.flickcurl_add_param(fc, "privacy_filter", privacy_filter_s);
		} 
		ModernizedCProgram.flickcurl_append_photos_list_params(fc, list_params, /* Photos List parameters */format);
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.people.getPhotos")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		photos_list = flickcurl_s.flickcurl_invoke_photos_list(fc, ()"/rsp/photos", format);
	...
	public static [] flickcurl_people_getPhotosOf_params(flickcurl_s[] fc, Object[] user_id, [] list_params) {
		...
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.people.getPhotosOf")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		photos_list = flickcurl_s.flickcurl_invoke_photos_list(fc, ()"/rsp/photos", format);
	...
	public static [] flickcurl_favorites_getList2_params(flickcurl_s[] fc, Object[] user_id, Object[] min_fave_date, Object[] max_fave_date, [] list_params) {
		...
		if (min_fave_date) {
			flickcurl_s.flickcurl_add_param(fc, "min_fave_date", min_fave_date);
		} 
		if (max_fave_date) {
			flickcurl_s.flickcurl_add_param(fc, "max_fave_date", max_fave_date);
		} 
		ModernizedCProgram.flickcurl_append_photos_list_params(fc, list_params, /* Photos List parameters */format);
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.favorites.getList")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		photos_list = flickcurl_s.flickcurl_invoke_photos_list(fc, ()"/rsp/photos", format);
	...
	public static [] flickcurl_favorites_getPublicList_params(flickcurl_s[] fc, Object[] user_id, [] list_params) {
		...
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.favorites.getPublicList")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		photos_list = flickcurl_s.flickcurl_invoke_photos_list(fc, ()"/rsp/photos", format);
	...
	public static void flickcurl_oauth_free([] od) {
	...
	public static int flickcurl_oauth_build_key([] od) {
		byte p;
		Object generatedKey = od.getKey();
		if (generatedKey) {
			.free(generatedKey);
		} 
		Object generatedClient_secret_len = od.getClient_secret_len();
		od.setKey_len(generatedClient_secret_len + 1);
		Object generatedRequest_token_secret_len = od.getRequest_token_secret_len();
		Object generatedKey_len = od.getKey_len();
		Object generatedToken_secret_len = od.getToken_secret_len();
		...
		od.setKey((byte).malloc(generatedKey_len + /* for NUL */1));
		if (!generatedKey) {
			return 1;
		} 
		p = generatedKey;
	 ...
	 * Return value: base64 encoded char of input value
	 */
	public static byte[] flickcurl_oauth_compute_signature([] od, Object[] len_p) {
		byte[] s1;
		byte[] result;
		Object generatedData = od.getData();
		Object generatedData_len = od.getData_len();
		Object generatedKey = od.getKey();
		Object generatedKey_len = od.getKey_len();
	...
	public static int flickcurl_photos_geo_batchCorrectLocation(flickcurl_s[] fc, [] location, Object[] place_id, int woe_id) {
		...
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_add_param(fc, "lat", latitude_s);
		.sprintf(longitude_s, "%f", generatedLongitude);
		flickcurl_s.flickcurl_add_param(fc, "lon", longitude_s);
		.sprintf(accuracy_s, "%d", generatedAccuracy);
		flickcurl_s.flickcurl_add_param(fc, "accuracy", accuracy_s);
		if (place_id) {
		...
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.photos.geo.batchCorrectLocation")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
	...
	public static [] flickcurl_photos_geo_photosForLocation_params(flickcurl_s[] fc, [] location, [] list_params) {
		...
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.photos.geo.photosForLocation")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		photos_list = flickcurl_s.flickcurl_invoke_photos_list(fc, ()"/rsp/photos", format);
	...
	public static int flickcurl_photos_geo_setLocation(flickcurl_s[] fc, Object[] photo_id, [] location) {
		...
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.photos.geo.setLocation")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		doc = flickcurl_s.flickcurl_invoke(fc);
	...
	public static int flickcurl_photos_geo_setPerms(flickcurl_s[] fc, Object[] photo_id, [] perms) {
		...
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_add_param(fc, "is_public", is_public_str);
		Object generatedIs_contact = perms.getIs_contact();
		.sprintf(is_contact_str, "%d", (generatedIs_contact ? 1 : 0));
		flickcurl_s.flickcurl_add_param(fc, "is_contact", is_contact_str);
		Object generatedIs_friend = perms.getIs_friend();
		.sprintf(is_friend_str, "%d", (generatedIs_friend ? 1 : 0));
		flickcurl_s.flickcurl_add_param(fc, "is_friend", is_friend_str);
		Object generatedIs_family = perms.getIs_family();
		.sprintf(is_family_str, "%d", (generatedIs_family ? 1 : 0));
		flickcurl_s.flickcurl_add_param(fc, "is_family", is_family_str);
		flickcurl_s.flickcurl_add_param(fc, "photo_id", photo_id);
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.photos.geo.setPerms")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		doc = flickcurl_s.flickcurl_invoke(fc);
	...
	public static [] flickcurl_photos_upload_params(flickcurl_s[] fc, [] params) {
		...
		if (._access((byte)generatedPhoto_file, 4)) {
			flickcurl_s.flickcurl_error(fc, "Photo file %s cannot be read: %s", generatedPhoto_file, .strerror((._errno())));
			return ((Object)0);
		} 
		...
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (generatedTitle) {
			flickcurl_s.flickcurl_add_param(fc, "title", generatedTitle);
		} 
		Object generatedDescription = params.getDescription();
		if (generatedDescription) {
			flickcurl_s.flickcurl_add_param(fc, "description", generatedDescription);
		} 
		Object generatedTags = params.getTags();
		if (generatedTags) {
			flickcurl_s.flickcurl_add_param(fc, "tags", generatedTags);
		} 
		if (generatedSafety_level >= 0) {
			flickcurl_s.flickcurl_add_param(fc, "safety_level", safety_level_s);
		} 
		if (generatedContent_type >= 0) {
			flickcurl_s.flickcurl_add_param(fc, "content_type", content_type_s);
		} 
		flickcurl_s.flickcurl_add_param(fc, "is_public", is_public_s);
		flickcurl_s.flickcurl_add_param(fc, "is_friend", is_friend_s);
		flickcurl_s.flickcurl_add_param(fc, "is_family", is_family_s);
		if (generatedHidden >= 0) {
			flickcurl_s.flickcurl_add_param(fc, "hidden", hidden_s);
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_end_params(fc);
		byte[] generatedUpload_service_uri = fc.getUpload_service_uri();
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare_upload(fc, generatedUpload_service_uri, "photo", generatedPhoto_file)) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		doc = flickcurl_s.flickcurl_invoke(fc);
		...
		flickcurl_s flickcurl_s = new flickcurl_s();
		status.setPhotoid(flickcurl_s.flickcurl_xpath_eval(fc, xpathCtx, ()"/rsp/photoid"));
	...
	public static void flickcurl_free_upload_status([] status) {
		do {
			if (!status) {
	...
	public static void flickcurl_upload_status_free([] status) {
	 ...
	 */
	public static void flickcurl_free_exif([] exif) {
		do {
			if (!exif) {
		...
		Object generatedTagspace = exif.getTagspace();
		if (generatedTagspace) {
			.free(generatedTagspace);
		} 
		Object generatedLabel = exif.getLabel();
		if (generatedLabel) {
			.free(generatedLabel);
		} 
		Object generatedRaw = exif.getRaw();
		if (generatedRaw) {
			.free(generatedRaw);
		} 
		Object generatedClean = exif.getClean();
		if (generatedClean) {
			.free(generatedClean);
		} 
		.free(exif/**
	...
	public static void flickcurl_free_exifs([][] exifs_object) {
		int i;
		do {
			if (!exifs_object) {
	...
	public static int read_ini_config(Object[] filename, Object[] section, Object[] user_data, Object handler) {
		flickcurl_s flickcurl_s = new flickcurl_s();
		return flickcurl_s.flickcurl_config_read_ini(((Object)0), filename, section, user_data, handler/**
	...
	public static void flickcurl_config_var_handler(Object[] userdata, Object[] key, Object[] value) {
		...
		if (!.strcmp(key, "api_key")) {
			flickcurl_s.flickcurl_set_api_key(fc, value);
		}  else if (!.strcmp(key, "secret")) {
			flickcurl_s.flickcurl_set_shared_secret(fc, value);
		}  else if (!.strcmp(key, "auth_token")) {
			flickcurl_s.flickcurl_set_auth_token(fc, value);
		}  else if (!.strcmp(key, "oauth_client_key")) {
			flickcurl_s.flickcurl_set_oauth_client_key(fc, value);
		}  else if (!.strcmp(key, "oauth_client_secret")) {
			flickcurl_s.flickcurl_set_oauth_client_secret(fc, value);
		}  else if (!.strcmp(key, "oauth_token")) {
			flickcurl_s.flickcurl_set_oauth_token(fc, value);
		}  else if (!.strcmp(key, "oauth_token_secret")) {
			flickcurl_s.flickcurl_set_oauth_token_secret(fc, value/**
	...
	public static int main(int argc, byte[][] argv) {
		...
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_set_error_handler(fc, my_message_handler, ((Object)0));
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (!.access((byte)ModernizedCProgram.flickcurl_cmdline_config_path, R_OK)) {
			if (flickcurl_s.flickcurl_config_read_ini(fc, ModernizedCProgram.flickcurl_cmdline_config_path, ModernizedCProgram.flickcurl_cmdline_config_section, fc, ModernizedCProgram.flickcurl_config_var_handler)) {
				rc = 1;
				;
			} 
		} 
		...
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (request_delay >= 0) {
			flickcurl_s.flickcurl_set_request_delay(fc, request_delay);
		} 
		...
		flickcurl_serializer_s flickcurl_serializer_s = new flickcurl_serializer_s();
		if (fs) {
			flickcurl_serializer_s.flickcurl_free_serializer(fs);
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (fc) {
			flickcurl_s.flickcurl_free(fc);
		} 
		if (serializer) {
		...
		while (!usage && !help) {
			...
			case (byte)'h':
					...
					break;
			case (byte)'a':
					auth_token = flickcurl_s.flickcurl_auth_getFullToken(fc, /* Exchange the frob for a full token */ModernizedCProgram.optarg);
					if (!auth_token) {
						...
						rc = 1;
							...
							flickcurl_s.flickcurl_set_auth_token(fc, auth_token);
	...
	public static [] flickcurl_galleries_getPhotos_params(flickcurl_s[] fc, Object[] gallery_id, [] list_params) {
		...
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_add_param(fc, "gallery_id", /* API parameters */gallery_id);
		ModernizedCProgram.flickcurl_append_photos_list_params(fc, list_params, /* Photos List parameters */format);
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.galleries.getPhotos")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		photos_list = flickcurl_s.flickcurl_invoke_photos_list(fc, ()"/rsp/gallery", format);
		return photos_list/**
	...
	public static [] flickcurl_photos_getContactsPhotos_params(flickcurl_s[] fc, int contact_count, int just_friends, int single_photo, int include_self, [] list_params) {
		...
		if (contact_count > /* API parameters */1) {
			...
			flickcurl_s.flickcurl_add_param(fc, "count", count_s);
		} 
		if (just_friends) {
			flickcurl_s.flickcurl_add_param(fc, "just_friends", true_s);
		} 
		if (single_photo) {
			flickcurl_s.flickcurl_add_param(fc, "single_photo", true_s);
		} 
		if (include_self) {
			flickcurl_s.flickcurl_add_param(fc, "include_self", true_s);
		} 
		ModernizedCProgram.flickcurl_append_photos_list_params(fc, list_params, /* Photos List parameters */format);
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.photos.getContactsPhotos")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		photos_list = flickcurl_s.flickcurl_invoke_photos_list(fc, ()"/rsp/photos", format);
	...
	public static [] flickcurl_photos_getContactsPublicPhotos_params(flickcurl_s[] fc, Object[] user_id, int photo_count, int just_friends, int single_photo, int include_self, [] list_params) {
		...
		flickcurl_s.flickcurl_add_param(fc, "count", photo_count_s);
		if (just_friends) {
			flickcurl_s.flickcurl_add_param(fc, "just_friends", true_s);
		} 
		if (single_photo) {
		...
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.photos.getContactsPublicPhotos")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		photos_list = flickcurl_s.flickcurl_invoke_photos_list(fc, ()"/rsp/photos", format);
	...
	public static [] flickcurl_photos_getRecent_params(flickcurl_s[] fc, [] list_params) {
		...
		byte[] format = ((Object)0);
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_init_params(fc, 0/* No API parameters */);
		ModernizedCProgram.flickcurl_append_photos_list_params(fc, list_params, /* Photos List parameters */format);
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.photos.getRecent")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		photos_list = flickcurl_s.flickcurl_invoke_photos_list(fc, ()"/rsp/photos", format);
	...
	public static [] flickcurl_photos_recentlyUpdated_params(flickcurl_s[] fc, int min_date, [] list_params) {
		...
		if (min_date > /* API parameters */0) {
			...
			flickcurl_s.flickcurl_add_param(fc, "min_date", min_date_s);
		} 
		ModernizedCProgram.flickcurl_append_photos_list_params(fc, list_params, /* Photos List parameters */format);
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.photos.recentlyUpdated")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		photos_list = flickcurl_s.flickcurl_invoke_photos_list(fc, ()"/rsp/photos", format);
	...
	public static [] flickcurl_photos_search_params(flickcurl_s[] fc, [] params, [] list_params) {
		...
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (generatedUser_id) {
			flickcurl_s.flickcurl_add_param(fc, "user_id", generatedUser_id);
		} 
		Object generatedTags = params.getTags();
		if (generatedTags) {
			flickcurl_s.flickcurl_add_param(fc, "tags", generatedTags);
		...
		if (generatedTag_mode) {
			flickcurl_s.flickcurl_add_param(fc, "tag_mode", generatedTag_mode);
		} 
		Object generatedText = params.getText();
		if (generatedText) {
			flickcurl_s.flickcurl_add_param(fc, "text", generatedText);
		} 
		...
		if (generatedMin_taken_date) {
			flickcurl_s.flickcurl_add_param(fc, "min_taken_date", generatedMin_taken_date);
		} 
		Object generatedMax_taken_date = params.getMax_taken_date();
		if (generatedMax_taken_date) {
			flickcurl_s.flickcurl_add_param(fc, "max_taken_date", generatedMax_taken_date);
		} 
		Object generatedLicense = params.getLicense();
		if (generatedLicense) {
			flickcurl_s.flickcurl_add_param(fc, "license", generatedLicense);
		} 
		Object generatedSort = params.getSort();
		if (generatedSort) {
			flickcurl_s.flickcurl_add_param(fc, "sort", generatedSort);
		} 
		Object generatedPrivacy_filter = params.getPrivacy_filter();
		if (generatedPrivacy_filter) {
			flickcurl_s.flickcurl_add_param(fc, "privacy_filter", generatedPrivacy_filter);
		} 
		Object generatedBbox = params.getBbox();
		if (generatedBbox) {
			flickcurl_s.flickcurl_add_param(fc, "bbox", generatedBbox);
		} 
		...
		if (generatedMachine_tags) {
			flickcurl_s.flickcurl_add_param(fc, "machine_tags", generatedMachine_tags);
		} 
		Object generatedMachine_tag_mode = params.getMachine_tag_mode();
		if (generatedMachine_tag_mode) {
			flickcurl_s.flickcurl_add_param(fc, "machine_tag_mode", generatedMachine_tag_mode);
		} 
		Object generatedGroup_id = params.getGroup_id();
		if (generatedGroup_id) {
			flickcurl_s.flickcurl_add_param(fc, "group_id", generatedGroup_id);
		} 
		Object generatedPlace_id = params.getPlace_id();
		if (generatedPlace_id) {
			flickcurl_s.flickcurl_add_param(fc, "place_id", generatedPlace_id);
		} 
		Object generatedMedia = params.getMedia();
		if (generatedMedia) {
			flickcurl_s.flickcurl_add_param(fc, "media", generatedMedia);
		} 
		Object generatedHas_geo = params.getHas_geo();
		if (generatedHas_geo) {
			flickcurl_s.flickcurl_add_param(fc, "has_geo", "1");
		} 
		...
		if (generatedGeo_context > 0 && generatedGeo_context < 3) {
			...
			flickcurl_s.flickcurl_add_param(fc, "geo_context", geo_context_s);
		} 
		...
		if (generatedRadius) {
			if (generatedLat) {
				...
				flickcurl_s.flickcurl_add_param(fc, "lat", lat_s);
			} 
			if (generatedLon) {
				.sprintf(lon_s, "%f", generatedLon);
				flickcurl_s.flickcurl_add_param(fc, "lon", lon_s);
			} 
			if (generatedRadius) {
				.sprintf(radius_s, "%f", generatedRadius);
				flickcurl_s.flickcurl_add_param(fc, "radius", radius_s);
				if (generatedRadius_units) {
					flickcurl_s.flickcurl_add_param(fc, "radius_units", generatedRadius_units);
				} 
			} 
		} 
		Object generatedContacts = params.getContacts();
		if (generatedContacts && generatedUser_id) {
			flickcurl_s.flickcurl_add_param(fc, "contacts", generatedContacts);
		} 
		Object generatedWoe_id = params.getWoe_id();
		if (generatedWoe_id > 0) {
			.sprintf(woe_id_s, "%d", generatedWoe_id);
			flickcurl_s.flickcurl_add_param(fc, "woe_id", woe_id_s);
		} 
		Object generatedIs_commons = params.getIs_commons();
		if (generatedIs_commons) {
			flickcurl_s.flickcurl_add_param(fc, "is_commons", "");
		} 
		Object generatedIn_gallery = params.getIn_gallery();
		if (generatedIn_gallery) {
			flickcurl_s.flickcurl_add_param(fc, "in_gallery", "");
		} 
		ModernizedCProgram.flickcurl_append_photos_list_params(fc, list_params, /* Photos List parameters */format);
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.photos.search")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		photos_list = flickcurl_s.flickcurl_invoke_photos_list(fc, ()"/rsp/photos", format);
	...
	public static int flickcurl_photos_setPerms(flickcurl_s[] fc, Object[] photo_id, [] perms) {
		...
		flickcurl_s.flickcurl_add_param(fc, "perm_comment", perm_comment_str);
		.sprintf(perm_addmeta_str, "%d", generatedPerm_addmeta);
		flickcurl_s.flickcurl_add_param(fc, "perm_addmeta", perm_addmeta_str);
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.photos.setPerms")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		doc = flickcurl_s.flickcurl_invoke(fc);
	 ...
	 * 
	 */
	public static void flickcurl_free_blog([] blog) {
		do {
			if (!blog) {
		...
		Object generatedId = blog.getId();
		if (generatedId) {
			.free(generatedId);
		} 
		Object generatedName = blog.getName();
		if (generatedName) {
			.free(generatedName);
		} 
		.free(blog/**
	...
	public static void flickcurl_free_blogs([][] blogs_object) {
		int i;
		do {
			if (!blogs_object) {
	...
	public static void flickcurl_free_blog_service([] blog_service) {
		do {
			if (!blog_service) {
	...
	public static void flickcurl_free_blog_services([][] blog_services_object) {
		int i;
		do {
	...
	public static [] flickcurl_groups_pools_getPhotos_params(flickcurl_s[] fc, Object[] group_id, Object[] tags, Object[] user_id, [] list_params) {
		...
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_add_param(fc, "group_id", /* API parameters */group_id);
		if (tags) {
		...
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.groups.pools.getPhotos")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		photos_list = flickcurl_s.flickcurl_invoke_photos_list(fc, ()"/rsp/photos", format);
	 ...
	 */
	public static void flickcurl_free_ticket([] ticket) {
		do {
			if (!ticket) {
	...
	public static void flickcurl_free_tickets([][] tickets_object) {
		int i;
		do {
			if (!tickets_object) {
	 ...
	 */
	public static void flickcurl_free_stat([] stat) {
		do {
			if (!stat) {
		...
		Object generatedName = stat.getName();
		if (generatedName) {
			.free(generatedName);
		} 
		Object generatedUrl = stat.getUrl();
		if (generatedUrl) {
			.free(generatedUrl);
		} 
		Object generatedSearchterms = stat.getSearchterms();
	...
	public static void flickcurl_free_stats([][] stats_object) {
		int i;
		do {
			if (!stats_object) {
	...
	public static void flickcurl_free_view_stats([] view_stats) {
		do {
			if (!view_stats) {
	 ...
	 * 
	 */
	public static void flickcurl_free_activity_event([] activity_event) {
		do {
			if (!activity_event) {
		...
		Object generatedId = activity_event.getId();
		if (generatedId) {
			.free(generatedId);
		} 
		Object generatedType = activity_event.getType();
		if (generatedType) {
			.free(generatedType);
		} 
		Object generatedUser = activity_event.getUser();
		if (generatedUser) {
			.free(generatedUser);
		} 
		Object generatedUsername = activity_event.getUsername();
		if (generatedUsername) {
			.free(generatedUsername);
		} 
		Object generatedValue = activity_event.getValue();
		if (generatedValue) {
			.free(generatedValue);
		} 
		.free(activity_event);
	}
	public static void flickcurl_free_activity([] activity) {
		int i;
		do {
			if (!activity) {
		...
		Object generatedType = activity.getType();
		if (generatedType) {
			.free(generatedType);
		} 
		Object generatedId = activity.getId();
		if (generatedId) {
			.free(generatedId);
		} 
		Object generatedOwner = activity.getOwner();
		if (generatedOwner) {
			.free(generatedOwner);
		} 
		Object generatedOwner_name = activity.getOwner_name();
		if (generatedOwner_name) {
			.free(generatedOwner_name);
		} 
		Object generatedPrimary = activity.getPrimary();
		if (generatedPrimary) {
			.free(generatedPrimary);
		} 
		Object generatedSecret = activity.getSecret();
		if (generatedSecret) {
			.free(generatedSecret);
		} 
		Object generatedTitle = activity.getTitle();
		if (generatedTitle) {
			.free(generatedTitle);
		} 
		Object generatedEvents = activity.getEvents();
		for (i = 0; generatedEvents[i]; i++) {
			ModernizedCProgram.flickcurl_free_activity_event(generatedEvents[i]);
		}
		.free(activity/**
	...
	public static void flickcurl_free_activities([][] activities_object) {
		int i;
		do {
	...
	public static [] flickcurl_photos_comments_getRecentForContacts_params(flickcurl_s[] fc, int date_lastcomment, Object[] contacts_filter, [] list_params) {
		...
		if (date_lastcomment >= /* API parameters */0) {
			...
			flickcurl_s.flickcurl_add_param(fc, "date_lastcomment", date_lastcomment_str);
		} 
		if (contacts_filter) {
			flickcurl_s.flickcurl_add_param(fc, "contacts_filter", contacts_filter);
		} 
		ModernizedCProgram.flickcurl_append_photos_list_params(fc, list_params, /* Photos List parameters */format);
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.photos.comments.getRecentForContacts")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		photos_list = flickcurl_s.flickcurl_invoke_photos_list(fc, ()"/rsp/photos", format);
	...
	public static [] flickcurl_photosets_getPhotos_params(flickcurl_s[] fc, Object[] photoset_id, int privacy_filter, [] list_params) {
		...
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_add_param(fc, "photoset_id", /* API parameters */photoset_id);
		if (privacy_filter >= 1 && privacy_filter <= 5) {
			.sprintf(privacy_filter_str, "%d", privacy_filter);
			flickcurl_s.flickcurl_add_param(fc, "privacy_filter", privacy_filter_str);
		} 
		ModernizedCProgram.flickcurl_append_photos_list_params(fc, list_params, /* Photos List parameters */format);
		flickcurl_s flickcurl_s = new flickcurl_s();
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.photosets.getPhotos")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		photos_list = flickcurl_s.flickcurl_invoke_photos_list(fc, ()"/rsp/photoset", format);
		return photos_list/**
	 ...
	 */
	public static void flickcurl_free_location([] location) {
		do {
			if (!location) {
	...
	public static void flickcurl_free_place([] place) {
		int i;
		do {
			if (!place) {
		...
		if (generatedShape) {
			flickcurl_shapedata_s.flickcurl_free_shape(generatedShape);
		} 
		Object generatedTimezone = place.getTimezone();
	...
	public static void flickcurl_free_places([][] places_object) {
		int i;
		do {
			if (!places_object) {
	...
	public static void flickcurl_free_place_type_infos([][] ptis_object) {
		int i;
		do {
			if (!ptis_object) {
	...
	public static void mangen_print_man_page(_iobuf[] fh) {
		int i;
	...
	public static void mangen_print_extras(_iobuf[] fh) {
		int i;
		.fputs("<variablelist>\n", fh);
		for (i = 0; 1; i++) {
			byte[] name;
	...
	public static byte[] MD5_string(byte[] string) {
		...
		mD5Context.MD5Init(md5);
		MD5Context mD5Context = new MD5Context();
		mD5Context.MD5Update(md5, (byte)string, len);
		MD5Context mD5Context = new MD5Context();
		mD5Context.MD5Final(md5);
	 ...
	 */
	public static void flickcurl_free_user_upload_status([] u) {
		do {
			if (!u) {
	...
	public static [] flickcurl_interestingness_getList_params(flickcurl_s[] fc, Object[] date, [] list_params) {
		...
		flickcurl_s.flickcurl_end_params(fc);
		flickcurl_s flickcurl_s = new flickcurl_s();
		if (flickcurl_s.flickcurl_prepare(fc, "flickr.interestingness.getList")) {
			;
		} 
		flickcurl_s flickcurl_s = new flickcurl_s();
		photos_list = flickcurl_s.flickcurl_invoke_photos_list(fc, ()"/rsp/photos", format);
	...
	public static void command_print_person([] person) {
		int i;
		Object generatedNsid = person.getNsid();
	...
	public static int command_print_location([] location) {
		byte[] accuracy_label;
		Object generatedAccuracy = location.getAccuracy();
	...
	public static void command_print_place([] place, Object[] label, Object[] value, int print_locality) {
		int i;
		if (label) {
			.fprintf((_iob[1]), "%s: %s %s places\n", ModernizedCProgram.program, label, (value ? value : "(none)"));
		} 
		Object generatedType = place.getType();
		...
		if (generatedLocation.getAccuracy() != 0) {
			...
			ModernizedCProgram.command_print_location(generatedLocation);
		} 
		Object generatedTimezone = place.getTimezone();
		if (generatedTimezone) {
		...
		flickcurl_shapedata_s flickcurl_shapedata_s = new flickcurl_shapedata_s();
		if (generatedShape) {
			flickcurl_shapedata_s.command_print_shape(generatedShape);
		} 
		Object generatedCount = place.getCount();
		if (generatedCount > 0) {
	...
	public static void command_print_video([] v) {
		Object generatedReady = v.getReady();
		Object generatedFailed = v.getFailed();
		Object generatedPending = v.getPending();
		Object generatedDuration = v.getDuration();
		Object generatedWidth = v.getWidth();
		Object generatedHeight = v.getHeight();
	...
	public static void command_print_perms([] perms, int show_comment_metadata) {
	...
	public static void command_print_group([] g) {
		Object generatedNsid = g.getNsid();
		Object generatedName = g.getName();
		Object generatedDescription = g.getDescription();
		Object generatedLang = g.getLang();
		Object generatedRules = g.getRules();
		Object generatedIs_admin = g.getIs_admin();
		Object generatedIs_moderator = g.getIs_moderator();
		Object generatedIs_member = g.getIs_member();
		Object generatedIs_pool_moderated = g.getIs_pool_moderated();
		Object generatedPrivacy = g.getPrivacy();
		Object generatedIconserver = g.getIconserver();
		Object generatedIconfarm = g.getIconfarm();
		Object generatedPhotos = g.getPhotos();
		Object generatedMembers = g.getMembers();
		Object generatedThrottle_count = g.getThrottle_count();
		Object generatedThrottle_mode = g.getThrottle_mode();
		Object generatedThrottle_remaining = g.getThrottle_remaining();
		Object generatedPool_count = g.getPool_count();
		Object generatedTopic_count = g.getTopic_count();
		Object generatedPhotos_ok = g.getPhotos_ok();
		Object generatedVideos_ok = g.getVideos_ok();
		Object generatedImages_ok = g.getImages_ok();
		Object generatedScreens_ok = g.getScreens_ok();
		Object generatedArt_ok = g.getArt_ok();
		Object generatedSafe_ok = g.getSafe_ok();
		Object generatedModerate_ok = g.getModerate_ok();
		Object generatedRestricted_ok = g.getRestricted_ok();
		Object generatedHas_geo = g.getHas_geo();
	...
	public static void command_print_exif([] e) {
		Object generatedTagspace = e.getTagspace();
		Object generatedTagspaceid = e.getTagspaceid();
		Object generatedTag = e.getTag();
		Object generatedLabel = e.getLabel();
	...
	public static void command_print_photoset([] photoset) {
		Object generatedId = photoset.getId();
		Object generatedPrimary = photoset.getPrimary();
		Object generatedSecret = photoset.getSecret();
		Object generatedServer = photoset.getServer();
		Object generatedFarm = photoset.getFarm();
		Object generatedPhotos_count = photoset.getPhotos_count();
		Object generatedTitle = photoset.getTitle();
		Object generatedDescription = photoset.getDescription();
	...
	public static void command_print_activity([] a) {
		int i;
		Object generatedType = a.getType();
		Object generatedId = a.getId();
		Object generatedOwner = a.getOwner();
		Object generatedOwner_name = a.getOwner_name();
		Object generatedPrimary = a.getPrimary();
		Object generatedSecret = a.getSecret();
		Object generatedServer = a.getServer();
		Object generatedFarm = a.getFarm();
		Object generatedComments = a.getComments();
		Object generatedComments_old = a.getComments_old();
		Object generatedComments_new = a.getComments_new();
		Object generatedNotes_old = a.getNotes_old();
		Object generatedNotes_new = a.getNotes_new();
		Object generatedViews = a.getViews();
		Object generatedPhotos = a.getPhotos();
		Object generatedFaves = a.getFaves();
		Object generatedMore = a.getMore();
	...
	public static void command_print_predicate_values([][] tag_pvs, Object[] label) {
		int i;
		if (label) {
			.fprintf((_iob[1]), "%s: %s\n", ModernizedCProgram.program, label);
		} 
	...
	public static void command_print_institution([] institution, int ix) {
		int i;
		Object generatedNsid = institution.getNsid();
		Object generatedDate_launch = institution.getDate_launch();
		Object generatedName = institution.getName();
	...
	public static void command_print_member([] member, int i) {
		Object generatedNsid = member.getNsid();
		Object generatedUsername = member.getUsername();
		Object generatedIconserver = member.getIconserver();
		Object generatedIconfarm = member.getIconfarm();
		Object generatedMember_type = member.getMember_type();
	...
	public static void command_print_gallery([] g) {
		Object generatedId = g.getId();
		Object generatedUrl = g.getUrl();
		Object generatedOwner = g.getOwner();
		Object generatedDate_create = g.getDate_create();
		Object generatedDate_update = g.getDate_update();
		Object generatedCount_photos = g.getCount_photos();
		Object generatedCount_videos = g.getCount_videos();
		...
		flickcurl_photo_s flickcurl_photo_s = new flickcurl_photo_s();
		flickcurl_photo_s.command_print_photo(generatedPrimary_photo);
	}
	public static void command_print_stat([] s) {
		Object generatedViews = s.getViews();
		Object generatedComments = s.getComments();
		Object generatedFavorites = s.getFavorites();
		...
		Object generatedUrl = s.getUrl();
		if (generatedUrl) {
			.fprintf((_iob[1]), "  Url %s", generatedUrl);
		} 
		Object generatedSearchterms = s.getSearchterms();
		if (generatedSearchterms) {
			.fprintf((_iob[1]), "  Search terms %s", generatedSearchterms);
		} 
		.fputc((byte)'\n', (_iob[1]));
	}
	public static void command_print_stats([][] stats) {
		int i;
		for (i = 0; stats[i]; i++) {
	...
	public static void flickcurl_free_tag_cluster([] tc) {
		do {
			if (!tc) {
	...
	public static void flickcurl_free_tag_clusters([] tcs) {
		do {
			if (!tcs) {
		...
		if (generatedClusters) {
			...
			for (i = 0; generatedClusters[i]; i++) {
				ModernizedCProgram.flickcurl_free_tag_cluster(generatedClusters[i]);
			}
	 ...
	 */
	public static void flickcurl_free_size([] size) {
		do {
			if (!size) {
		...
		Object generatedUrl = size.getUrl();
		if (generatedUrl) {
			.free(generatedUrl);
		} 
	...
	public static void flickcurl_free_sizes([][] sizes_object) {
		int i;
		do {
			if (!sizes_object) {
	...
	public static void flickcurl_free_person([] person) {
		int i;
		do {
			if (!person) {
	...
	public static void flickcurl_free_persons([][] persons) {
		int i;
		do {
			if (!persons) {
	 ...
	 */
	public static void flickcurl_free_perms([] perms) {
		do {
			if (!perms) {
	 ...
	 */
	public static void flickcurl_free_photoset([] photoset) {
		do {
			if (!photoset) {
		...
		Object generatedOwner = photoset.getOwner();
		if (generatedOwner) {
			.free(generatedOwner);
		} 
		.free(photoset/**
	...
	public static void flickcurl_free_photosets([][] photosets_object) {
		int i;
		do {
			if (!photosets_object) {
	 ...
	 */
	public static void flickcurl_free_group([] group) {
		do {
			if (!group) {
		...
		Object generatedNsid = group.getNsid();
		if (generatedNsid) {
			.free(generatedNsid);
		} 
		Object generatedName = group.getName();
		if (generatedName) {
			.free(generatedName);
		} 
		Object generatedDescription = group.getDescription();
		if (generatedDescription) {
			.free(generatedDescription);
		} 
		Object generatedLang = group.getLang();
		if (generatedLang) {
			.free(generatedLang);
		} 
		Object generatedThrottle_mode = group.getThrottle_mode();
	...
	public static void flickcurl_free_groups([][] groups_object) {
		int i;
		do {
			if (!groups_object) {
	...
	public static void flickcurl_free_photos_list([] photos_list) {
		do {
			if (!photos_list) {
	...
	public static void raptor_free_term([] term) {
		Object generatedType = term.getType();
		Object generatedValue = term.getValue();
	...
	public static void raptor_free_serializer([] s) {
		.free(s);
	}
	public static void raptor_serializer_set_namespace([] serializer, Object[] uri, Object[] prefix) {
		Object generatedFh = serializer.getFh();
		FILE[] fh = generatedFh;
	...
	public static void raptor_serializer_serialize_statement([] serializer, [] s) {
		Object generatedFh = serializer.getFh();
		FILE[] fh = generatedFh;
	...
	public static void raptor_serializer_serialize_end([] serializer) {
		Object generatedFh = serializer.getFh();
		.fflush(generatedFh);
	}
	public static void raptor_statement_init( statement, Object[] world) {
		.memset(statement, (byte)'\0', );
		return ;
	}
	public static void raptor_statement_clear([] statement) {
		Object generatedSubject = statement.getSubject();
		ModernizedCProgram.raptor_free_term(generatedSubject);
		Object generatedPredicate = statement.getPredicate();
		ModernizedCProgram.raptor_free_term(generatedPredicate);
		Object generatedObject = statement.getObject();
		ModernizedCProgram.raptor_free_term(generatedObject);
	}
	/* -*- Mode: c; c-basic-offset: 2 -*-
	 *
	 ...
	 */
	public static void flickcurl_free_gallery([] gallery) {
		do {
			if (!gallery) {
		...
		Object generatedId = gallery.getId();
		if (generatedId) {
			.free(generatedId);
		} 
		Object generatedUrl = gallery.getUrl();
		if (generatedUrl) {
			.free(generatedUrl);
		} 
		Object generatedOwner = gallery.getOwner();
		if (generatedOwner) {
			.free(generatedOwner);
		} 
		Object generatedPrimary_photo = gallery.getPrimary_photo();
		flickcurl_photo_s flickcurl_photo_s = new flickcurl_photo_s();
		if (generatedPrimary_photo) {
			flickcurl_photo_s.flickcurl_free_photo(generatedPrimary_photo);
		} 
		Object generatedTitle = gallery.getTitle();
		if (generatedTitle) {
			.free(generatedTitle);
		} 
		Object generatedDescription = gallery.getDescription();
		if (generatedDescription) {
			.free(generatedDescription);
		} 
		.free(gallery/**
	...
	public static void flickcurl_free_galleries([][] galleries_object) {
		int i;
		do {
			if (!galleries_object) {
	...
	*/
	public static int flickcurl_serialize_photo(flickcurl_serializer_s[] fcs, flickcurl_photo_s[] photo) {
		...
		nspaces = flickrdf_nspace_s.nspace_add_if_not_declared(nspaces, ((Object)0), /* Always add XSD, RDF and Flickr namespaces */"http://www.w3.org/2001/XMLSchema#");
		nspaces = flickrdf_nspace_s.nspace_add_if_not_declared(nspaces, "rdf", "http://www.w3.org/1999/02/22-rdf-syntax-ns#");
		nspaces = flickrdf_nspace_s.nspace_add_if_not_declared(nspaces, "flickr", "http://machinetags.org/ns/Flickr#");
		[] generatedPlace = photo.getPlace();
		if (generatedPlace) {
			nspaces = flickrdf_nspace_s.nspace_add_if_not_declared(nspaces, "places", "http://machinetags.org/ns/Places#");
		} 
		byte[] generatedId = photo.getId();
		flickcurl_s flickcurl_s = new flickcurl_s();
		sizes = flickcurl_s.flickcurl_photos_getSizes(fc, generatedId);
		if (sizes) {
			need_foaf = 1;
			need_rdfs = 1;
		} 
		...
		for (i = .PHOTO_FIELD_FIRST; i <= .PHOTO_FIELD_LAST; /* mark namespaces used in fields */i++) {
			...
			for (f = 0; field_table[f].getField() != .PHOTO_FIELD_none; f++) {
				...
				nspaces = flickrdf_nspace_s.nspace_add_if_not_declared(nspaces, ((Object)0), field_table[f].getNspace_uri());
				break;
			}
		}
		int generatedTags_count = photo.getTags_count();
		...
		for (i = 0; i < generatedTags_count; /* in tags look for xmlns:PREFIX = "URI" otherwise look for PREFIX: */i++) {
			...
			if (!.strncmp(generatedRaw, "xmlns:", 6)) {
				...
				nspaces = flickrdf_nspace_s.nspace_add_new(nspaces, prefix, p + 1);
				p = (byte)'=';
				continue;
			} 
			prefix = generatedRaw;
			...
			p = (byte)'\0';
			nspaces = flickrdf_nspace_s.nspace_add_if_not_declared(nspaces, prefix, ((Object)0));
			p = (byte)':';
		}
		if (need_person) {
			need_foaf = 1;
			nspaces = flickrdf_nspace_s.nspace_add_if_not_declared(nspaces, "dc", "http://purl.org/dc/terms/");
		} 
		if (need_foaf) {
			nspaces = flickrdf_nspace_s.nspace_add_if_not_declared(nspaces, "foaf", "http://xmlns.com/foaf/0.1/");
		} 
		if (need_rdfs) {
			nspaces = flickrdf_nspace_s.nspace_add_if_not_declared(nspaces, "rdfs", "http://www.w3.org/2000/01/rdf-schema#");
		} 
		...
		for (i = .PHOTO_FIELD_FIRST; i <= .PHOTO_FIELD_LAST; /* generate triples from fields */i++) {
			...
			for (f = 0; field_table[f].getField() != .PHOTO_FIELD_none; f++) {
				...
				if (field == .PHOTO_FIELD_license) {
					...
					license = flickcurl_s.flickcurl_photos_licenses_getInfo_by_id(fc, generatedFields[field].getInteger());
					if (!license) {
						if (new_object) {
							.free(new_object);
						} 
		...
		for (i = 0; i < generatedTags_count; /* generate triples from tags */i++) {
			...
			ns = flickrdf_nspace_s.nspace_get_by_prefix(nspaces, prefix);
			if (!ns) {
				continue;
			} 
		...
		flickrdf_nspace_s flickrdf_nspace_s = new flickrdf_nspace_s();
		if (nspaces) {
			flickrdf_nspace_s.free_nspaces(nspaces);
		} 
	...
	public static void flickcurl_free_context([] context) {
		do {
			if (!context) {
	...
	public static void flickcurl_free_contexts([][] contexts) {
		int i;
		do {
			if (!contexts) {
	 ...
	 */
	public static void flickcurl_free_institution([] institution) {
		int i;
		do {
			if (!institution) {
	...
	public static void flickcurl_free_institutions([][] institutions_object) {
		int i;
		do {
	 ...
	 */
	public static void flickcurl_free_tag_namespace([] tag_nspace) {
		Object generatedName = tag_nspace.getName();
		if (generatedName) {
			.free(generatedName);
		} 
		.free(tag_nspace);
	}
	public static void flickcurl_free_tag_namespaces([][] tag_nspaces) {
		int i;
		do {
			if (!tag_nspaces) {
	...
	public static void flickcurl_free_tag_predicate_value([] tag_pv) {
		Object generatedPredicate = tag_pv.getPredicate();
		if (generatedPredicate) {
			.free(generatedPredicate);
		} 
		Object generatedValue = tag_pv.getValue();
		if (generatedValue) {
			.free(generatedValue);
		} 
		.free(tag_pv/*
	...
	public static void flickcurl_free_tag_predicate_values([][] tag_pvs) {
		int i;
		do {
			if (!tag_pvs) {
	 ...
	 */
	public static void flickcurl_free_member([] member_object) {
		do {
			if (!member_object) {
		...
		Object generatedNsid = member_object.getNsid();
		if (generatedNsid) {
			.free(generatedNsid);
		} 
		Object generatedUsername = member_object.getUsername();
		if (generatedUsername) {
			.free(generatedUsername);
		} 
		.free(member_object/**
	...
	public static void flickcurl_free_members([][] members_object) {
		int i;
		do {
			if (!members_object) {

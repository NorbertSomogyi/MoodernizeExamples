...
public class ModernizedCProgram {
	...
	public static Integer flickcurl_photos_getCounts;
	...
	public static Byte flickcurl_cmdline_config_path = (null);
	 ...
	 * Return value: label string or NULL if none valid
	 */};
	public static raptor_syntax_description[] serializers = new raptor_syntax_description[]{{new raptor_syntax_description("ntriples", (null)), "N-Triples"}, {new raptor_syntax_description("turtle", (null)), "Turtle"}};
	...
	public static  flickcurl_favorites_getList_params(flickcurl_s fc, Object user_id,  list_params) {
		return ModernizedCProgram.flickcurl_favorites_getList2_params(fc, user_id, (null), (null), list_params/**
	...
	public static void print_help_string() {
		...
		for (i = 0; 1; i++) {
			Byte name;
			Byte label;
			if (ModernizedCProgram.flickcurl_get_feed_format_info(i, name, label, (null))) {
				break;
			} 
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/printf("    %-16s %s\n", name, label);
		}
	...
	public static Object raptor_new_uri_from_uri(Object uri) {
		return ModernizedCProgram.raptor_new_uri((null), (byte)uri);
	}
	...
	public static Object flickcurl_write_callback(Object ptr, Object size, Object nmemb, Object userdata) {
		...
		if (generatedXml_parse_content) {
			if (!generatedXc) {
				 xc = new ();
				xc = /*Error: Function owner not recognized*/xmlCreatePushParserCtxt((null), (null), (byte)ptr, len, (byte)generatedUri);
				if (!xc) {
					rc = 1;
				} else {
	...
	public static int getopt(int argc, byte[][] argv, Object optstring) {
		...
		ModernizedCProgram.optarg = (null);
		...
		if (c == (byte)':' || c == /* optstring syntax conflict */(byte)'?' || (cp = /*Error: Function owner not recognized*/strchr(optstring, c)) == (null)) {
	...
	public static void flickcurl_serializer_init() {
		int i;
		for (i = 0; ModernizedCProgram.namespace_table[i].getPrefix() != (null); i++) {
	...
	public static int flickcurl_serialize_photo(flickcurl_serializer_s fcs, flickcurl_photo_s photo) {
		...
		nspaces = nspaces.nspace_add_if_not_declared((null), /* Always add XSD, RDF and Flickr namespaces */"http://www.w3.org/2001/XMLSchema#");
		...
		for (i = .PHOTO_FIELD_FIRST; i <= .PHOTO_FIELD_LAST; /* mark namespaces used in fields */i++) {
			...
			for (f = 0; field_table[f].getField() != .PHOTO_FIELD_none; f++) {
				...
				nspaces = nspaces.nspace_add_if_not_declared((null), field_table[f].getNspace_uri());
				break;
			}
		}
		...
		for (i = 0; i < generatedTags_count; /* in tags look for xmlns:PREFIX = "URI" otherwise look for PREFIX: */i++) {
			...
			p = (byte)'\0';
			nspaces = nspaces.nspace_add_if_not_declared(prefix, (null));
			p = (byte)':';
		}
		if (need_person) {
			need_foaf = 1;
		...
		if (need_person) {
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(generatedData, generatedUri, .FLICKCURL_TERM_TYPE_RESOURCE, "http://purl.org/dc/terms/", "creator", "person", .FLICKCURL_TERM_TYPE_BLANK, (null));
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(generatedData, "person", .FLICKCURL_TERM_TYPE_BLANK, "http://www.w3.org/1999/02/22-rdf-syntax-ns#", "type", "http://xmlns.com/foaf/0.1/Person", .FLICKCURL_TERM_TYPE_RESOURCE, (null));
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(generatedData, "person", .FLICKCURL_TERM_TYPE_BLANK, "http://xmlns.com/foaf/0.1/", "maker", generatedUri, .FLICKCURL_TERM_TYPE_RESOURCE, (null));
		} 
		...
		for (i = .PHOTO_FIELD_FIRST; i <= .PHOTO_FIELD_LAST; /* generate triples from fields */i++) {
			...
			for (f = 0; field_table[f].getField() != .PHOTO_FIELD_none; f++) {
				Byte datatype_uri = (null);
				Byte object = (null);
				Byte new_object = (null);
		...
		for (i = 0; i < generatedTags_count; /* generate triples from tags */i++) {
			...
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(generatedData, generatedUri, .FLICKCURL_TERM_TYPE_RESOURCE, generatedUri, f, v, .FLICKCURL_TERM_TYPE_LITERAL, (null));
		}
		...
		if (generatedPlace) {
			...
			for (i = (int)0; i <= (int).FLICKCURL_PLACE_LAST; i++) {
				...
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(generatedData, generatedUri, .FLICKCURL_TERM_TYPE_RESOURCE, "http://machinetags.org/ns/Places#", "place", place_bnode, .FLICKCURL_TERM_TYPE_BLANK, (null));
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(generatedData, place_bnode, .FLICKCURL_TERM_TYPE_BLANK, "http://www.w3.org/1999/02/22-rdf-syntax-ns#", "type", "http://machinetags.org/ns/Places#Place", .FLICKCURL_TERM_TYPE_RESOURCE, (null));
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(generatedData, place_bnode, .FLICKCURL_TERM_TYPE_BLANK, "http://machinetags.org/ns/Places#", "type", ModernizedCProgram.flickcurl_get_place_type_label((flickcurl_place_type)i), .FLICKCURL_TERM_TYPE_LITERAL, (null));
				if (name) {
					/*Error: Function owner not recognized*//*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(generatedData, place_bnode, .FLICKCURL_TERM_TYPE_BLANK, "http://machinetags.org/ns/Places#", "name", name, .FLICKCURL_TERM_TYPE_LITERAL, (null));
				} 
				if (id) {
					/*Error: Function owner not recognized*//*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(generatedData, place_bnode, .FLICKCURL_TERM_TYPE_BLANK, "http://machinetags.org/ns/Places#", "id", id, .FLICKCURL_TERM_TYPE_LITERAL, (null));
				} 
				if (woe_id) {
					/*Error: Function owner not recognized*//*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(generatedData, place_bnode, .FLICKCURL_TERM_TYPE_BLANK, "http://machinetags.org/ns/Places#", "placeid", woe_id, .FLICKCURL_TERM_TYPE_LITERAL, (null));
				} 
				if (url) {
					/*Error: Function owner not recognized*//*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(generatedData, place_bnode, .FLICKCURL_TERM_TYPE_BLANK, "http://machinetags.org/ns/Places#", "url", url, .FLICKCURL_TERM_TYPE_RESOURCE, (null));
				} 
			}
		} 
		...
		if (/* generate triples from sizes */sizes) {
			for (i = 0; sizes[i]; i++) {
				...
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(generatedData, generatedUri, .FLICKCURL_TERM_TYPE_RESOURCE, "http://machinetags.org/ns/Flickr#", sizePredicate, generatedSource, .FLICKCURL_TERM_TYPE_RESOURCE, (null));
				/*Error: Function owner not recognized*//*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(generatedData, generatedSource, .FLICKCURL_TERM_TYPE_RESOURCE, "http://www.w3.org/1999/02/22-rdf-syntax-ns#", "type", sizeClass, .FLICKCURL_TERM_TYPE_RESOURCE, (null));
				if (generatedLabel) {
					/*Error: Function owner not recognized*//*Error: Function owner not recognized*/ERROR_UNRECOGNIZED_FUNCTIONNAME(generatedData, generatedSource, .FLICKCURL_TERM_TYPE_RESOURCE, "http://www.w3.org/2000/01/rdf-schema#", "label", generatedLabel, .FLICKCURL_TERM_TYPE_LITERAL, (null));
				} 
	...
	public static int read_ini_config(Object filename, Object section, Object user_data, Object handler) {
		return (null).flickcurl_config_read_ini(filename, section, user_data, handler/**

...
public class flickcurl_s {
	...
	public int command_photos_setDates(int argc, byte[][] argv) {
		...
		date_posted = /*Error: Function owner not recognized*/curl_getdate(argv[2], ((Object)0));
		date_taken = /*Error: Function owner not recognized*/curl_getdate(argv[3], ((Object)0));
	...
	public int command_photos_search(int argc, byte[][] argv) {
		...
		while (!usage && argc) {
			...
			if (!/*Error: Function owner not recognized*/strcmp(field, "user")) {
				...
				params.setMin_upload_date(/*Error: Function owner not recognized*/curl_getdate(argv[0], ((Object)/* timestamp */0)));
				argv++;
				argc--;
			}  else if (!/*Error: Function owner not recognized*/strcmp(field, "max-upload-date")) {
				params.setMax_upload_date(/*Error: Function owner not recognized*/curl_getdate(argv[0], ((Object)/* timestamp */0)));
				argv++;
				argc--;
	...
	public int flickcurl_invoke_common(Byte content_p, Object size_p, Object docptr_p) {
		...
		if (generatedXml_parse_content) {
			 ...
			 attr = new ();
			int failed = 0;
			/*Error: Function owner not recognized*//*Error: Function owner not recognized*/xmlParseChunk(generatedXc, ((Object)0), 0, 1);
	...
	public Byte flickcurl_xpath_eval_to_tree_string(Object xpathNodeCtx, Object xpathExpr, Object length_p) {
		...
		save_ctxt = /*Error: Function owner not recognized*/xmlSaveToBuffer(buffer, ((Object)0), /* encoding *//* opts */0);
